	...
	const slides = [
		{
			title: 'ARMOUR PLATE',
			description:
				'Our inventory is tested and certified according to global benchmarks, ensuring consistent protection across various threat levels:',
			points: [
				'EN 1522: European standard for windows, doors, shutters, and blinds (Ballistic Resistance).',
				'MIL-A 46100D: U.S. Military specification for high-hardness armor steel plate.',
				'STANAG 4569: NATO standards for protection levels for occupants of armored vehicles.',
			],
