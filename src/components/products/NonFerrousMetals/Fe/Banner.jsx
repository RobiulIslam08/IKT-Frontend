...
export default function Banner() {
  const slides = [
    {
      title: 'IKT Invar Round Bar & Rod (UNS K93600 / 36®)',
      description:
        'Invar 36 is a premier nickel-iron alloy engineered for ultra-low thermal expansion. Maintaining dimensions ten times better than carbon steel up to 204°C, it is the essential solution for Saudi Arabia\'s high-precision aerospace and telecommunication sectors.',
      points: [
        'Minimal dimensional changes across extreme temperature variations.',
        'Industry standard for measurement devices and electronic sensor packaging.',
      ],
