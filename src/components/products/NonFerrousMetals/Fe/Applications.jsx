...
export default function Applications() {
  const applications = [
    'Precision Measurement and Metrology Instrumentation',
    'Telecommunications Electronic Packages and Circuit Housing',
    'Aeronautical and Aerospace Engineering Components',
    'Industrial Sensor Packages and Thermostatic Controls',
    'Laser and Optical System Structural Supports',
    'Bimetallic Strip Components for Thermal Motion',
    'Cryogenic Liquid Gas Containment Structural Rods'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Invar Round Bar Industrial Applications" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
