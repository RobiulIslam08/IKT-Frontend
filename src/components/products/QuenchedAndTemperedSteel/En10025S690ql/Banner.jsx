...
export default function Banner() {
	...
	const slides = [
		{
			title: 'EN 10025 S690QL',
			description:
				'High-Performance Structural Steel S690QL is a high-strength, quenched and tempered structural steel grade engineered for exceptional load-bearing capacity and durability. Despite its immense strength, this material is designed for superior weldability and ease of fabrication, making it a preferred choice for complex engineering projects.',
			points: [
				'High Strength Quenched & Tempered (Q&T) Plate',
