...
export default function MaterialSpecificationsTableEn690ql() {
  const brandColor = '#06afcf';

  // 1. Properties - Chemical Composition Data
  const chemicalData = {
  ...
  const mechanicalData = [
    { thickness: '3mm to 50mm', yield: '690', tensile: '770 - 940', elongation: '14', impact: '30 @ -40° C' },
    { thickness: '50mm to 100mm', yield: '650', tensile: '760 - 930', elongation: '14', impact: '30 @ -40° C' },
    { thickness: '100mm to 150mm', yield: '630', tensile: '710 - 900', elongation: '14', impact: '30 @ -40° C' }
  ];
  ...
  return (
    <motion.div 
      ...
      animate="visible"
    >
      {/* Section 1: Properties (Chemical Composition) */}
      <section>
        ...
        <div className="relative border border-gray-100 rounded-lg shadow-sm overflow-hidden max-w-7xl mx-auto">
          <div className="overflow-x-auto">
            <table className="w-full min-w-[800px] text-center border-collapse">
              <thead>
                <tr style={{ backgroundColor: brandColor }}>
                  <th className="py-4 px-2 text-white font-bold border-r border-white/20 text-[11px] md:text-base">Plate thickness mm</th>
                  <th className="py-4 px-2 text-white font-bold border-r border-white/20 text-[11px] md:text-base">Yield strength Reh (MPA)</th>
                  <th className="py-4 px-2 text-white font-bold border-r border-white/20 text-[11px] md:text-base">Tensile strength Rm (MPA)</th>
                  <th className="py-4 px-2 text-white font-bold border-r border-white/20 text-[11px] md:text-base">Elongation A5 % minimum</th>
