...
export default function Banner() {
	...
	const slides = [
		{
			title: 'Quenched and Tempered Steel Sheets and Plates',
			description:
				'IKT provides one of the most extensive inventories of high-strength Quenched and Tempered (Q&T) structural steel plates in the region. Our specialized Q&T steel sheets are engineered to deliver mechanical performance that far exceeds standard structural requirements, making them ideal for high-load and extreme-condition applications.',
			points: [
