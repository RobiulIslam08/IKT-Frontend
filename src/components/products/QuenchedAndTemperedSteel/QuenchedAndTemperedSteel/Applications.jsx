...
export default function Applications() {
	const applications = [
	"Deep Mining Roof Support Systems",
  "Heavy-Duty Hydraulic Systems",
  "High-Precision Oilfield Fabrications",
  "Advanced Offshore Crane Components",
  "Articulated Dump Truck Structural Frames",
  "High-Performance Excavator Buckets",
  "Heavy-Duty Bulldozer Blades",
  "Quarrying Screens and Crusher Units",
  "Industrial Waste Compaction Equipment",
  "High-Strength Crane Boom Assemblies",
  "Defense and Tactical Equipment Components"
	]
