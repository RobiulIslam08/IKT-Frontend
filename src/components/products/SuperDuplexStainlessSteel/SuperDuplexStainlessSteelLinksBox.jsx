...
const superDuplexStainlessSteelLinks = [
	{ label: 'UNS S32750 (1.4410)', href: '/products/uns-s32750-1-4410' },
	{ label: 'UNS S32760 (1.4501)', href: '/products/uns-s32760-1-4501' },
];

const SuperDuplexStainlessSteelLinksBox = () => {
	...
	return (
		<section className="px-4 sm:px-6 lg:px-8 py-10 bg-slate-50">
			<div className="max-w-7xl mx-auto border border-slate-200 rounded-2xl p-6 md:p-8 bg-white shadow-sm text-center">
				<div className="mb-5">
					<h2 className="text-2xl md:text-3xl font-bold text-slate-900">Super Duplex Stainless Steel</h2>
					<p className="text-sm md:text-base text-slate-600 mt-2">
						Browse all Super Duplex Stainless Steel grades and specifications from one place.
					</p>
				</div>

				<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 justify-items-center">
					{superDuplexStainlessSteelLinks.map((item) => {
...
export default SuperDuplexStainlessSteelLinksBox;
