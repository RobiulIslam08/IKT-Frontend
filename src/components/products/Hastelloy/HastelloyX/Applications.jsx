...
export default function Applications() {
  const applications = [
    'Gas Turbine Engine Components and Burners',
    'Industrial Heating Furnaces and Retorts',
    'Heavy-Duty Petrochemical Processing Plants',
    'Power Generation and Nuclear Facilities',
    'Aviation and Aerospace Forged Parts',
    'High-Temperature Exhaust and Piping Systems',
    'Critical Chemical Reactor Infrastructure'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Hastelloy X Gas Turbine Engineering"
