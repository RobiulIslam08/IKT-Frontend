...
export default function Applications() {
  const applications = [
    'Flue Gas and Sulfur Dioxide Scrubber Systems',
    'Industrial Chlorination and Pesticide Production',
    'Nuclear Fuel Reprocessing and Wastewater Treatment',
    'Pulp and Paper Bleach Plants and Cellophane Manufacturing',
    'Pharmaceutical and Chemical Processing Equipment',
    'Incineration Scrubbers and Heavy Pickling Systems',
    'Corrosion-Resistant Seawater and Marine Assemblies'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Hastelloy C22 Chemical Processing Systems"
