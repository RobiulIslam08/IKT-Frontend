...
export default function PropertiesTable() {
  ...
  const physicalData = [
    ...
    { property: 'Melting Point', value: '1399 °C (2550 °F)' },
    { property: 'Elastic Modulus', value: '29,878 ksi (~206 GPa)' },
    { property: 'Thermal Conductivity (@ 100°C)', value: '11.1 W/m-K' },
    { property: 'Specific Heat Capacity', value: '414 J/Kg-K' },
    { property: 'Mean CTE (24 to 93°C)', value: '12.4 μm/m-°C' },
    { property: 'Electrical Resistivity', value: '1.215 µΩm' },
    { property: 'Magnetic Permeability', value: '≤ 1.001 (Non-Magnetic)' }
  ];

  const astmSpecifications = [
    { form: 'Seamless Pipe & Tube', specs: 'ASTM B622' },
    { form: 'Welded Pipe & Tube', specs: 'ASTM B619 / B626' },
    { form: 'Sheet, Strip & Plate', specs: 'ASTM B575' },
    { form: 'Rod, Bar & Wire', specs: 'ASTM B574' },
    { form: 'Fittings & Forgings', specs: 'ASTM B366 / B564' },
    { form: 'Welding Fillers', specs: 'ASME SFA5.14 (ERNiCRMo-10)' }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 text-center">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT Hastelloy C22 chemistry, advanced physical parameters, and global ASTM compliance.</p>
        </motion.div>
        ...
        <div className="flex flex-col gap-10">
          ...
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200">
                    <th className="px-6 py-4 text-center font-bold border-r border-gray-100">Standard / Region</th>
                    <th className="px-6 py-4 text-center font-bold">Grade Specification</th>
                  </tr>
                </thead>
                <tbody>
                  {equivalentsData.map((row, index) => (
          ...
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200">
                    <th className="px-6 py-4 text-center font-bold border-r border-gray-100">Alloying Element</th>
                    <th className="px-6 py-4 text-center font-bold">Content Ratio (%)</th>
                  </tr>
                </thead>
                <tbody>
                  {chemicalData.map((row, index) => (
                    <tr key={index} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base">{row.content}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          {/* 4. Physical & Thermal Dynamics Table */}
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full">
            <div className="bg-primary/10 px-6 py-4 border-b border-gray-200 text-center">
        ...
        <motion.div variants={itemVariants} className="mt-12 p-8 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Extreme Logistics in KSA:</span>
            Hastelloy C22 structural components, including chemical-grade plates, seamless pipes, tubes, and precision fasteners, are heavily stocked across Saudi Arabia to support rapid deployment in high-stakes waste and acid processing environments.
          </p>
          <p className="text-base font-medium text-gray-600">
            For critical procurement operations, specific sizing details, or exact ASTM material certification, please consult our expert engineering team in Saudi Arabia at <span className="font-bold text-primary">+966-13-3444036</span>.
          </p>
