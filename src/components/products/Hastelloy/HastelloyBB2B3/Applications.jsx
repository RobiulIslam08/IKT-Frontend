...
export default function Applications() {
  const applications = [
    'Hydrochloric Acid Processing and Storage Facilities',
    'Sulfuric Acid Production and Handling Equipment',
    'High-Temperature Chemical Reactor Vessels',
    'Pharmaceutical and Agricultural Chemical Plants',
    'Acetic and Phosphoric Acid Processing Units',
    'Corrosion-Resistant Industrial Fasteners and Bolts',
    'Advanced Petrochemical Distillation Towers'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Hastelloy B3 Chemical Processing Equipment"
