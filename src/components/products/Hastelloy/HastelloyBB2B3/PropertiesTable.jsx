    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT Hastelloy B3 & B2 chemistry, mechanical contrasts, and fabrication protocols.</p>
        </motion.div>
        ...
        <div className="flex flex-col gap-10">
          ...
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200">
                    <th className="px-6 py-4 text-center font-bold border-r border-gray-100">Alloy Name</th>
                    <th className="px-6 py-4 text-center font-bold border-r border-gray-100">UNS Number</th>
                    <th className="px-6 py-4 text-center font-bold">Werkstoff Nr.</th>
                  </tr>
                </thead>
                <tbody>
                  {equivalentsData.map((row, index) => (
                    <tr key={index} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base border-r border-gray-100">{row.alloy}</td>
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base border-r border-gray-100">{row.standard}</td>
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base">{row.werkstoff}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200">
                    <th className="px-6 py-4 text-center font-bold border-r border-gray-100">Element</th>
                    <th className="px-6 py-4 text-center font-bold border-r border-gray-100">Alloy B2 (%)</th>
                    <th className="px-6 py-4 text-center font-bold">Hastelloy B3 (%)</th>
                  </tr>
                </thead>
                <tbody>
                  {chemicalData.map((row, index) => (
                    <tr key={index} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base border-r border-gray-100">{row.element}</td>
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base border-r border-gray-100">{row.b2}</td>
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base">{row.b3}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md p-6 md:p-8 w-full">
        ...
        {/* Bottom Note */}
        <motion.div variants={itemVariants} className="mt-10 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Heavy Logistics in KSA:</span>
            Hastelloy B3 and Alloy B2 structural components, including chemical-grade plates, seamless pipes, tubes, and advanced fasteners, are heavily stocked across Saudi Arabia for immediate deployment.
          </p>
          <p className="text-base font-medium text-gray-600">
            For critical procurement or certifications, contact our engineering team in Saudi Arabia at <span className="font-bold text-primary">+966-13-3444036</span>.
          </p>
        </motion.div>
