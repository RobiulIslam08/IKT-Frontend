...
export default function Applications() {
  const applications = [
    'Sulfuric and Hydrofluoric Acid Processing Equipment',
    'Advanced Chemical Reactor Vessels and Heat Exchangers',
    'Petrochemical Distillation Towers and Piping',
    'Pharmaceutical Mixing Tanks and Centrifuges',
    'Industrial Acid Regeneration Systems',
    'High-Strength Corrosive Environment Fasteners',
    'Agrochemical and Pesticide Manufacturing Facilities'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Hastelloy C2000 Acid Processing Equipment"
