...
export default function Applications() {
  const applications = [
    'Aggressive Chemical Processing Vessels and Piping',
    'Pollution Control and Flue Gas Desulfurization',
    'High-Pressure Corrosive Gas Measurement Manometers',
    'Pulp and Paper Production Equipment',
    'Waste Treatment and Incineration Systems',
    'Heavy-Duty Chemical Fasteners and Bolts',
    'Extreme Temperature Heat Exchangers'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Hastelloy C276 Chemical Processing Towers"
