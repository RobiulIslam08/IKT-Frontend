...
export default function MaterialSpecificationsTablep460nl2() {
          ...
          <table className="w-full min-w-[1000px] text-center text-[10px] md:text-sm">
            ...
            <tbody className="text-gray-700 font-medium">
              <tr className="border-b border-gray-50">
                ...
                <td className="py-4 border-r border-gray-50">0.020</td>
                <td className="py-4 border-r border-gray-50">0.010</td>
                ...
                <td className="py-4 border-r border-gray-50">0.08</td>
          ...
          <table className="w-full min-w-[600px] text-center text-[10px] md:text-sm">
            ...
            <tbody className="text-gray-700">
              {[
                ...
                { thick: '16mm to 40mm', yield: '445 min', tensile: '570 - 720', elong: '17 min' },
                { thick: 'over 40mm to 60mm', yield: '430 min', tensile: '570 - 720', elong: '17 min' },
          ...
          <table className="w-full min-w-[700px] text-center text-[10px] md:text-sm border-collapse">
            ...
            <tbody className="text-gray-700 font-medium">
              <tr className="border-b border-gray-100 bg-gray-50/30">
                ...
                <td className="py-4 px-2 border-r border-gray-100 font-medium">60 J min</td>
              ...
              <tr className="border-b border-gray-100">
                ...
                <td className="py-4 px-2 border-r border-gray-100 font-medium">75 J min</td>
                <td className="py-4 px-2 font-medium">85 J min</td>
              </tr>
            </tbody>
          </table>
        </div>
