...
import image from "../../../../assets/images/HighSpeedSteel/T1/image2.png"

export default function Applications() {
  const applications = [
    'Advanced Milling and Reaming Cutters',
    'High-Performance Broaching and Drilling Tools',
    'Precision Gear Cutting Tools and Shavers',
    'Heavy-Duty Taps and Threading Dies',
    'High-Temperature Abrasion Machine Parts',
    'Vehicle Engine and Transmission Tooling',
    'Machining of Soft to Medium Materials (≤ 320 HB)'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="T1 HSS Milling and Drilling Tools"
