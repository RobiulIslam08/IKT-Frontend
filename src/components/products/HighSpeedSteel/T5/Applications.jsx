...
import image from "../../../../assets/images/HighSpeedSteel/T5/image2.png"

export default function Applications() {
  const applications = [
    'High-Speed Milling and Reaming Tools',
    'Advanced Broaching and Drilling Equipment',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="T5 High Speed Steel Cutting Tools"
