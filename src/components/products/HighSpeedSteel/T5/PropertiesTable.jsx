...
//     { standard: 'USA (ASTM)', specification: 'ASTM A600-1999' },
//     { standard: 'Grade Designation', specification: 'AISI T5 Tungsten-Cobalt HSS' },
//     { standard: 'Key Alloying Element', specification: 'Cobalt (Co) ~ 8.00% (Nominal)' }
//   ];
...
//     { parameter: 'Maximum Working Temperature', value: '630 °C' },
//     { parameter: 'Recommended Working Temperature', value: 'Below 600 °C' },
//     { parameter: 'Achievable Hardness', value: '62 ~ 70 HRC' },
//     { parameter: 'Machining Capability', value: 'Soft/Medium material below 300 ~ 320 HB' }
//   ];
...
//           </div>
//           <p className="text-base font-medium text-gray-600 ml-7">IKT T5 High Speed Steel chemistry, operating limits, and KSA tolerances.</p>
//         </motion.div>

//         {/* Specifications and Chemistry Grid */}
...
//                <h3 className="text-lg font-bold text-gray-800">General Specifications</h3>
//             </div>
//             <div className="overflow-x-auto">
//               <table className="w-full">
//                 <thead>
//                   <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200">
//                     <th className="px-6 py-4 text-left font-bold border-r border-gray-100">Standard / Note</th>
...
//                       <td className="px-6 py-4 text-left text-gray-700 font-medium">{row.specification}</td>
//                     </tr>
//                   ))}
//                 </tbody>
//               </table>
...
//           <div className="bg-primary/10 px-6 py-4 border-b border-gray-200">
//              <h3 className="text-lg font-bold text-gray-800">Operational & Hardness Parameters</h3>
//           </div>
//           <div className="overflow-x-auto">
//             <table className="w-full">
//               <thead>
//                 <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200">
//                   <th className="px-6 py-4 text-left font-bold border-r border-gray-100">Performance Metric</th>
//                   <th className="px-6 py-4 text-left font-bold">Standard Value</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {workingParameters.map((row, index) => (
//                   <tr key={index} className="text-gray-700 font-medium hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-0">
...
//               T5 HSS round bars and flat sections can be expertly cut to your precise sizes. We supply superior quality ground tool steel bars to exact mechanical tolerances.
//             </p>
//             <p className="text-base font-medium text-gray-600">For inquiries regarding unlisted dimensions, please contact our engineering team in Saudi Arabia at <span className="font-bold">+966-13-3444036</span>.</p>
//           </div>
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base text-gray-600">IKT T5 High Speed Steel chemistry, operating limits, and KSA precision tolerances.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            <div className="bg-white px-6 py-6 text-center">
              <h3 className="text-2xl font-bold text-gray-900 flex items-center justify-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary"></span> General Specifications
              </h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-white text-base text-gray-900 border-t border-b border-gray-200">
                    <th className="px-6 py-4 text-center font-bold border-r border-gray-100 w-1/2">Standard / Note</th>
                ...
                <tbody>
                  {specificationsData.map((row, index) => (
                    <tr key={index} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base w-1/2">{row.specification}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          {/* Operational & Hardness Parameters Table */}
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            <div className="bg-white px-6 py-6 text-center">
              <h3 className="text-2xl font-bold text-gray-900 flex items-center justify-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary"></span> Operational & Hardness Parameters
              </h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-white text-base text-gray-900 border-t border-b border-gray-200">
                    <th className="px-6 py-4 text-center font-bold border-r border-gray-100 w-1/2">Performance Metric</th>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Advanced Processing in KSA:</span> 
            T5 HSS round bars and flat sections can be expertly cut to your precise structural sizes. We supply superior quality ground tool steel bars to exact mechanical tolerances across Saudi Arabia.
          </p>
          <p className="text-base font-medium text-gray-600">
            For critical procurement inquiries or specialized engineering requests, please contact our expert team in Saudi Arabia at <span className="font-bold text-primary">+966-13-3444036</span> or email <span className="font-bold text-primary">sales@ikt.sa</span>.
          </p>
        </motion.div>
