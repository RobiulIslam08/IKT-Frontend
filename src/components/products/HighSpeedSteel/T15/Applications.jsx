...
export default function Applications() {
  const applications = [
    'High-Performance Reamers and Form Tools',
    'Advanced End Milling and Gear Cutting Tools',
    'Heavy-Duty Taps for Abrasive Materials',
    'High-Temperature Machining Equipment',
    'Precision Broaches and Drills',
    'Industrial Shavers and Custom Cutters',
    'Cutting Tools for Strong Alloy Processing'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="T15 HSS High Performance Cutters"
