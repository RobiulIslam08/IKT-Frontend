...
import image from "../../../../assets/images/HighSpeedSteel/M35/image1.png"

export default function Applications() {
  const applications = [
    'Heavy-Duty Twist Drills and Taps',
    'High-Performance Milling Cutters',
    'Precision Reamers and Broaches',
    'Industrial Saws and Cutting Blades',
    'High-Alloy Cold Work Tools',
    'Extreme Wear Punches and Dies',
    'High-Production Machine Components'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="M35 HSS Milling Cutters and Drills"
