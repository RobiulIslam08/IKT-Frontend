...
//   const chemicalData = [
//     { c: '0.93 - 1.05', si: '0.15 - 0.35', mn: '0.25 - 0.45', p: '≤ 0.025', s: '≤ 0.015', cr: '1.35 - 1.60' }
//   ];
...
//           </div>
//           <p className="text-base font-medium text-gray-600 ml-7">IKT 100Cr6 bearing alloy chemistry, thermal profiles, and KSA tolerances.</p>
//         </motion.div>
...
//               100Cr6 bearing steel round bars, pipes, and flat sections can be custom cut to your specific requirements. We supply precision ground tool steel bars to exact dimensional tolerances.
//             </p>
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base text-gray-600">IKT 100Cr6 bearing alloy chemistry, thermal profiles, and KSA tolerances for extreme load applications.</p>
        </motion.div>
            ...
            <div className="p-6 flex flex-col gap-4 border-t border-gray-200">
              {heatTreatmentSteps.map((step, index) => (
                <div key={index} className="bg-gray-50 border border-gray-100 p-4 rounded-lg flex flex-col sm:flex-row gap-4 items-start md:items-center">
                  <span className="px-4 py-2 bg-primary text-white text-base font-medium rounded-md min-w-[150px] w-[150px] text-center shadow-sm shrink-0">
                    {step.process}
                  </span>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Advanced Processing in KSA:</span> 
            100Cr6 bearing steel round bars, blocks, and flat sections can be custom cut to your specific industrial requirements. We supply high-quality precision ground tool steel bars to exact dimensional tolerances across Saudi Arabia.
          </p>
          <p className="text-base font-medium text-gray-600">
            For unlisted sizes or specific machining inquiries, please contact our expert engineering team in Saudi Arabia at <span className="font-bold text-primary">+966-13-3444036</span> or email <span className="font-bold text-primary">sales@ikt.sa</span>.
          </p>
        </motion.div>
