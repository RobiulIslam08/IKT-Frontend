...
export default function Applications() {
  const applications = [
    'Precision Bearings for Rotating Machinery',
    'High-Pressure Valve Bodies and Pump Fittings',
    'Heavy-Duty Transmission Shafts and Gears',
    'Steel Balls, Rollers, and Shaft Sleeves',
    'Internal Combustion Engine Components',
    'Mining Machinery and Steel Rolling Equipment',
    'High-Load Wheels and Double-Headed Bolts'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="100Cr6 Bearing Steel Machinery Parts"
