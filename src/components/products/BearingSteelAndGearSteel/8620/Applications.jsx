...
import image from "../../../../assets/images/BearingSteelAndGearingSteel/Steel8620/image2.png"

export default function Applications() {
  const applications = [
    'Automotive Toolholders and Engineering Parts',
    'Heavy-Duty Transmission Gears and Pinions',
    'High-Load Wheels and Drive Shafts',
    'Industrial Valve Bodies and Pump Fittings',
    'Precision Double-Headed Bolts and Fasteners',
    'Custom Case-Hardened Structural Components',
    'Wear-Resistant Machine Engine Parts'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="8620 Alloy Steel Machined Gears"
