...
//     { standard: 'Germany (DIN)', grade: '20MnCr5 / 1.7147' },
//     { standard: 'China (GB)', grade: '20MnCr5' },
//     { standard: 'Japan (JIS)', grade: 'G4053 Equivalent classes' },
//     { standard: 'USA (ASTM)', grade: 'Available based on application equivalency' }
//   ];

//   const chemicalData = [
//     { c: '0.17 - 0.22', si: '≤ 0.40', mn: '1.10 - 1.40', p: '≤ 0.035', s: '≤ 0.035', cr: '1.00 - 1.30' }
//   ];
...
//           </div>
//           <p className="text-base font-medium text-gray-600 ml-7">IKT 20MnCr5 gear steel chemistry, thermal processing, and KSA tolerances.</p>
//         </motion.div>
...
//                <h3 className="text-lg font-bold text-gray-800">Primary Equivalents</h3>
//             </div>
...
//             {/* Heat Treatment Steps - Text sizes updated to text-base */}
...
//               20MnCr5 gear steel round bars and flat sections can be expertly cut to your precise sizes. We supply superior quality ground tool steel bars to exact mechanical tolerances.
//             </p>
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base text-gray-600">IKT 20MnCr5 gear steel chemistry, thermal processing, and KSA precision tolerances.</p>
        </motion.div>

        {/* STRICTLY SINGLE COLUMN LAYOUT */}
        <div className="grid grid-cols-1 gap-8">

          {/* Primary Equivalents Table */}
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            <div className="bg-white px-6 py-6 text-center">
              <h3 className="text-2xl font-bold text-gray-900 flex items-center justify-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary"></span> Primary Equivalents
              </h3>
            </div>
            <div className="overflow-x-auto">
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Precision Gear Machining in KSA:</span> 
            20MnCr5 gear steel round bars and flat sections can be expertly cut to your precise sizes. We supply superior quality ground tool steel bars to exact mechanical tolerances across Saudi Arabia.
          </p>
