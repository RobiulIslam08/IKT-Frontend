...
import image from "../../../../assets/images/BearingSteelAndGearingSteel/Steel20MNCr5/image2.png"

export default function Applications() {
  const applications = [
    'Heavy-Duty Gears for Rotating Machinery',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="20MnCr5 Gear Steel Components"
