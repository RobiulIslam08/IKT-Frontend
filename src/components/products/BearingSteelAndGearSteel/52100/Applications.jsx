...
export default function Applications() {
  const applications = [
    ...
    'High-Load Valve Bodies and Pump Fittings',
    'Internal Combustion Engine Components',
    'Steel Balls, Rollers, and Shaft Sleeves',
    'Heavy-Duty Double-Headed Bolts and Gears',
    'Mining Machinery and Steel Rolling Equipment',
    'Electric Locomotives and Railway Vehicles'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="52100 Alloy Bearing Steel Applications"
