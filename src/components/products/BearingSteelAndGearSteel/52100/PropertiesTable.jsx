...
//     { standard: 'USA (AISI / ASTM / SAE)', grade: '52100 / G52986' },
//     { standard: 'Germany (DIN)', grade: '100Cr6 / 1.3505' },
//     { standard: 'Japan (JIS)', grade: 'SUJ2' },
//     { standard: 'China (GB)', grade: 'GCr15' },
//     { standard: 'France (AFNOR)', grade: '100C6' },
//     { standard: 'England (BS)', grade: '535A99' }
//   ];

//   const chemicalData = [
//     { c: '0.95 - 1.10', si: '0.15 - 0.35', mn: '0.25 - 0.45', p: '≤ 0.015', s: '≤ 0.015', cr: '1.35 - 1.60' }
//   ];
...
//   // Modified step data - ensures sizes are normal paragraph size
//   const heatTreatmentSteps = [
//     { process: "Forging", details: "Forge the material precisely between 927°C to 1205°C (1700°F to 2200°F), followed directly by an annealing process." },
//     { process: "Annealing", details: "Slowly heat to 872°C (1600°F), follow by slowly cooling to reduce cold working or machining stress. Maximum resulting hardness is 248 HB." },
//     { process: "Quenching", details: "Heat slowly to 816°C (1500°F). Quenching in oil will yield an initial high hardness of 62 to 66 HRc." },
//     { process: "Tempering (High)", details: "High temperature tempering at 650-700°C, then cool in air. Reduces hardness to a tougher 22-30 HRC." },
//     { process: "Tempering (Low)", details: "Low temperature tempering at 150-170°C, then cool in air. Retains a very high hardness of 61-66 HRC." },
//     { process: "Hot/Cold Work", details: "Hot working range is 205°C to 538°C (400°F to 1000°F). Can be cold worked using conventional techniques when annealed." }
//   ];
...
//           </div>
//           <p className="text-base font-medium text-gray-600 ml-7">IKT 52100 bearing alloy chemistry, equivalent standards, and KSA tolerances.</p>
//         </motion.div>
...
//             {/* Heat Treatment Steps (UPDATED TEXT SIZE) */}
...
//               52100 bearing steel round bars, pipes, and flat sections can be custom cut to your specific requirements. We supply precision ground tool steel bars to exact dimensional tolerances.
//             </p>
...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'USA (AISI / ASTM / SAE)', grade: '52100 / G52986' },
    { standard: 'Germany (DIN)', grade: '1.3505' },
    { standard: 'Japan (JIS)', grade: 'SUJ2' },
    { standard: 'China (GB)', grade: 'GCr15' },
    { standard: 'France (AFNOR)', grade: '100C6' },
    { standard: 'England (BS)', grade: '535A99' }
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base text-gray-600">IKT 52100 bearing alloy chemistry, equivalent standards, and KSA precision tolerances.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Advanced Processing in KSA:</span> 
            52100 bearing steel round bars, pipes, and flat sections can be custom cut to your specific requirements. We supply precision ground tool steel bars to exact dimensional tolerances across Saudi Arabia.
          </p>
          <p className="text-base font-medium text-gray-600">
            For critical procurement inquiries or specific machining details, please contact our expert engineering team in Saudi Arabia at <span className="font-bold text-primary">+966-13-3444036</span> or email <span className="font-bold text-primary">sales@ikt.sa</span>.
          </p>
        </motion.div>
