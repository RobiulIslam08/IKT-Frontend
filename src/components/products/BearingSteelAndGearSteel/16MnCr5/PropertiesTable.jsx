...
//           </div>
//           <p className="text-base font-medium text-gray-600 ml-7">IKT 16MnCr5 gear steel chemistry, thermal processing, and KSA tolerances.</p>
//         </motion.div>
...
//               16MnCr5 gear steel round bars and flat sections can be expertly cut to your precise sizes. We supply superior quality ground tool steel bars to exact mechanical tolerances.
//             </p>
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base text-gray-600">IKT 16MnCr5 gear steel chemistry, thermal processing, and KSA precision tolerances.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Precision Gear Machining in KSA:</span> 
            16MnCr5 gear steel round bars and flat sections can be expertly cut to your precise sizes. We supply superior quality ground tool steel bars to exact mechanical tolerances across Saudi Arabia.
          </p>
