...
import image from "../../../../assets/images/BearingSteelAndGearingSteel/Steel20CrMnTi/image2.png"

export default function Applications() {
  const applications = [
    'High-Load Gears for Rotating Machinery',
    'Mining Machinery Transmission Shafts',
    'Heavy-Duty Valve Bodies and Pump Fittings',
    'Internal Combustion Engine Components',
    'Electric Locomotive and Railway Parts',
    'Double-Headed Bolts and High-Tension Fasteners',
    'Steel Balls, Rollers, and Shaft Sleeves'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="20CrMnTi Gear Steel Components"
