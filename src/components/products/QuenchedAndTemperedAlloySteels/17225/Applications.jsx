...
import image from "../../../../assets/images/QuencedAndTempered/Steel1.7225/image1.png"

export default function Applications() {
  const applications = [
    'High Tensile Shafts, Bolts, and Spindles',
    'Locomotive Traction and Supercharger Gears',
    'Deep Well Oil Drill Pipe Joints (< 2000m)',
    'Oil and Gas Fishing Tools and Components',
    'Heavy-Duty Pressure Vessels',
    'Rear Axles and Connecting Rod Gears',
    'Bending Machine Moulds and Spring Clips'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="1.7225 Alloy Steel High Tensile Shafts"
