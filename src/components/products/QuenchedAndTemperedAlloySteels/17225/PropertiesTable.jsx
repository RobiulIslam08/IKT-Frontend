...
//     { country: 'Germany (DIN / EN 10083/3)', grade: '1.7225' },
//     { country: 'USA (ASTM A29 / AISI)', grade: '4140' },
//     { country: 'Japan (JIS G4053)', grade: 'SCM440' },
//     { country: 'China (GB/T 3077)', grade: '42CrMo' }
//   ];

//   // Chemical Composition
//   const chemicalData = [
//     { c: '0.38 - 0.43', si: '0.15 - 0.35', mn: '0.75 - 1.00', p: '≤ 0.035', s: '≤ 0.040', cr: '0.80 - 1.10', mo: '0.15 - 0.25' }
//   ];
...
//           </div>
//           <p className="text-base font-medium text-gray-600 ml-7">IKT 1.7225 / 4140 structural alloy equivalency, chemistry, and KSA tolerances.</p>
//         </motion.div>
...
//               1.7225 alloy steel round bars and flat sections can be cut precisely to your structural requirements. We supply high-quality precision ground tool steel bars to exact tolerances.
//             </p>
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base text-gray-600">IKT 1.7225 / 4140 structural alloy equivalency, chemistry, and KSA precision tolerances.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Precision Processing in KSA:</span> 
            1.7225 alloy steel round bars and flat sections can be cut precisely to your structural requirements. We supply high-quality precision ground tool steel bars to exact ISO tolerances across Saudi Arabia.
          </p>
          <p className="text-base font-medium text-gray-600">
            For unlisted sizes or specialized machining inquiries, please contact our expert engineering team in Saudi Arabia at <span className="font-bold text-primary">+966-13-3444036</span> or email <span className="font-bold text-primary">sales@ikt.sa</span>.
          </p>
        </motion.div>
