...
import image from "../../../../assets/images/QuencedAndTempered/Steel4340/image2.png"

export default function Applications() {
  const applications = [
    'Heavy Machinery and High-Load Axles',
    'Turbine Shafts and Jet Engine Components',
    'Helicopter Rotor Shafts (>250mm Diameter)',
    'High-Load Transmission Parts and Gears',
    'Heavy-Duty Crankshaft Fasteners',
    'High-Temperature Rotor Blades (>400°C)',
    'Ultra-High Strength Isothermal Quenched Parts'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="4340 Alloy Steel Turbine Shafts"
