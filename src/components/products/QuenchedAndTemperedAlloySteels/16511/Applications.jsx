...
import image from "../../../../assets/images/QuencedAndTempered/Steel1.6511/image2.png"

export default function Applications() {
  const applications = [
    'Automotive and Mechanical Engineering Parts',
    'Heavy Machinery Turbine and Rotor Shafts',
    'High Load Axial and Transmission Components',
    'Turbojet Engine Blades and Fasteners',
    'Locomotive Traction Gears and Superchargers',
    'High-Temperature Operation Shafts (>400°C)',
    'Deep Well Oil Drill Pipe Joints and Fishing Tools'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="1.6511 Structural Alloy Turbine Shafts"
