...
export default function Properties() {
	...
	const chemicalData = {
		title: "Properties",
		subtitle: "S31803 / S32205 Duplex Steel Properties",
		description: "Chemical Analysis (% max or range).",
		headers: ['C', 'Mn', 'P', 'S', 'Si', 'Cr', 'Ni', 'Mo', 'N'],
		values: ['0.03', '2.00', '0.03', '0.02', '1.00', '21.0 – 23.0', '4.5 – 6.5', '2.5 – 3.5', '0.08 – 0.20']
	};
	...
	const mechanicalData = {
		...
		values: ['620', '450', '25', '293']
	};

	const plateSizesData = [
		{ thickness: '5', sizes: ['12000 x 2000', '-', '-'] },
		{ thickness: '6', sizes: ['12000 x 2000', '12000 x 2500', '12000 x 3000'] },
		...
		{ thickness: '20', sizes: ['12000 x 2000', '12000 x 2500', '12000 x 3000'] },
		{ thickness: '25', sizes: ['12000 x 2000', '12000 x 2500', '12000 x 3000'] },
		{ thickness: '30', sizes: ['6000 x 2000', '5000 x 2500', '-'] },
		{ thickness: '35', sizes: ['6000 x 2000', '5000 x 2500', '-'] },
		{ thickness: '40', sizes: ['6000 x 2000', '5000 x 2500', '-'] },
		{ thickness: '45', sizes: ['6000 x 2000', '5000 x 2500', '-'] },
		{ thickness: '50', sizes: ['6000 x 2000', '5000 x 2500', '-'] },
	];
