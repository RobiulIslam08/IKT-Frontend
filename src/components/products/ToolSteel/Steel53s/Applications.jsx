...
export default function Applications() {
  const applications = [
    ...
    'Industrial Extrusion Dies and Mandrels',
    'Heavy-Duty Hot Chisels and Punches',
    'High-Temperature Pressure Pads',
    'Extrusion Stems, Rams, and Backer Blocks',
    'Robust Blanking and Bending Tools',
    'Advanced Hot Heading Equipment'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="53S Hot Forging and Extrusion Dies"
