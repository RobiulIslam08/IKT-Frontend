...
export default function Applications() {
  const applications = [
    'High-Performance Industrial Moulds',
    'Heavy-Duty Precision Punches',
    'Cold Forging and Swaging Dies',
    'High-Stress Forming Dies',
    'Extremely Durable Shears and Blades',
    'Precision Inspection Gauges',
    'Advanced DC53® Equivalent Tooling'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="D2 Supreme Cold Forging Dies"
