...
export default function Applications() {
  const applications = [
    'Precision Press Tools and Broaches',
    'Deep Drawing Dies and Slitting Cutters',
    'Industrial Marking Punches and Clipping Tools',
    'High-Accuracy Inspection Gauges',
    'Dimensionally Stable Jigs and Fixtures',
    'Heavy-Duty Taps and Screwing Tools',
    'Custom Cold Work Manufacturing Parts'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="09B Tool Steel Precision Engineering"
