...
export default function Applications() {
  const applications = [
    'High-Precision Blanking & Forming Dies',
    'Severe Wear Resistance Machine Parts',
    'Air-Hardened Precision Gauges',
    'Heavy-Duty Cutting and Shearing Blades',
    'Cold Work Drawing and Extrusion Dies',
    'Industrial Abrasive Handling Equipment',
    'Cost-Effective Pre-Machined Tooling Jigs'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="D6 Tool Steel Pre-machined Dies"
