...
export default function Applications() {
  const applications = [
    ...
    'Extrusion Dies, Stems, and Rams',
    'Heavy-Duty Mandrels and Punches',
    'Industrial Hot Chisels and Heading Tools',
    'High-Temperature Pressure Pads',
    'Durable Extrusion Backer Blocks',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="H13 Hot Forging and Extrusion Dies"
