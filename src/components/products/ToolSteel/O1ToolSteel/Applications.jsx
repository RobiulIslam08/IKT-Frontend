...
import image from "../../../../assets/images/ColdWorkToolSteel/O1/80ef5d50-de94-4938-96b2-b1610283c7da.png"

export default function Applications() {
  const applications = [
    'Deep Drawing Dies and Press Tools',
    'Precision Slitting Cutters & Broaches',
    'Heavy-Duty Clipping and Marking Punches',
    'Industrial Taps and Screwing Tools',
    'Highly Accurate Inspection Gauges',
    'Dimensional Stable Jigs and Fixtures',
    'Custom Cold Work Tooling Components'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="O1 Tool Steel Precision Dies"
