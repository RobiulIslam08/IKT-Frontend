...
export default function Applications() {
  const applications = [
    'Hot & Cold Forming Dies and Punches',
    'High-Speed Broaches, Drills & Cutters',
    'Plastic Injection & Die Casting Moulds',
    'Heavy-Duty Shear Blades and Guillotines',
    'Industrial Thread Rollers & Taps',
    'Pneumatic Chisels and Concrete Breakers',
    'Precision Machined Gauges & Jigs'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-[#1a3a4a]">Tooling & Die Industries</h2>
              </div>
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Industrial Die and Tool Manufacturing"
