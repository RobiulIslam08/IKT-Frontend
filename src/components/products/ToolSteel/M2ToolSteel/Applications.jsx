...
import image from "../../../../assets/images/HighSpeedSteel/M2/image2.png"

export default function Applications() {
  const applications = [
    'Precision Twist Drills and Reamers',
    'Industrial Broaching and Milling Tools',
    'High-Performance Taps and Metal Saws',
    'Cold Work Punching and Forming Dies',
    'Heavy-Duty Pressing Tools',
    'General Purpose Machining Cutters',
    'Moderate Hot-Hardness Tooling Components'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="M2 High Speed Milling and Drilling Tools"
