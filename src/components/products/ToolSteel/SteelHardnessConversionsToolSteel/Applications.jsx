...
export default function Applications() {
  const applications = [
    'Verifying Heat Treatment Processes',
    'Quality Control and Material Inspection',
    'Selecting Correct Tool Steels for KSA Industries',
    'Estimating Ultimate Tensile Strength',
    'Cross-Referencing International Data Sheets',
    'Machinability Analysis Before Production',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-[#1a3a4a]">Importance of Hardness Testing</h2>
              </div>
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Material Hardness Testing in KSA"
