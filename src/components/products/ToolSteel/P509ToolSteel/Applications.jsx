...
export default function Applications() {
  const applications = [
    'Chemically Aggressive PVC Moulding',
    'High-Precision Plastic Injection Moulds',
    'Abrasive Filler Plastic Processing',
    'Heavy-Duty Extrusion Tools',
    'Corrosion-Resistant Die-Casting Moulds',
    'High-Gloss Polished Mould Surfaces',
    'Specialized Medical & Food Grade Plastics'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="PS09 PVC Injection Moulding Tools"
