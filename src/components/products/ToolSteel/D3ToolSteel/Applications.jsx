...
export default function Applications() {
  const applications = [
    'Extreme Abrasion Blanking & Forming Dies',
    'Heavy-Duty Metal Forming Rolls',
    'High-Compression Press Tools',
    'Precision Industrial Punches',
    'Wear-Resistant Machine Guides',
    'Specialized Cold Work Slitters',
    'Custom High-Hardness Tooling'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="D3 High Wear Blanking Dies"
