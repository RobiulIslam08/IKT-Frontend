...
import image from "../../../../assets/images/PlasticMouldSteel/P20/f1592bb7-2b4b-4961-af3e-8f97da622892.png"

export default function Applications() {
  const applications = [
    'Plastic Injection Moulds and Frames',
    'Heavy-Duty Backers and Bolsters',
    'Industrial Die Holders',
    'High-Strength Rails and Shafts',
    'Machined Wear Strips',
    'Large-Scale Pressing Tools (P20N)',
    'Fast-Machined Structural Bases (P20S)'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="P20 Plastic Injection Moulds"
