...
export default function Applications() {
  const applications = [
    'Rapid Tool and Die Manufacturing',
    'Precision Jigs and Assembly Fixtures',
    'Ready-to-Machine Plastic Injection Mould Bases',
    'Time-Sensitive Engineering Prototypes',
    'Heavy-Duty Machine Bed Plates',
    'High-Precision Inspection Gauges',
    'Custom Punches and Press Tools'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Pre-Machined Economizer Tool Steels"
