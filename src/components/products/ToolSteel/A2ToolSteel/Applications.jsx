...
import image from "../../../../assets/images/ColdWorkToolSteel/A2/image2.png"

export default function Applications() {
  const applications = [
    'Heavy-Duty Blanking Tools and Punches',
    'Precision Trim and Forming Dies',
    'Industrial Inspection Gauges',
    'High-Impact Shear Blades',
    'Cold Work Stamping Dies',
    'General Purpose Tooling Jigs',
    'Wear and Shock Resistant Machine Parts'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="A2 Tool Steel Dies and Punches"
