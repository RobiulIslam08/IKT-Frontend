...
export default function Applications() {
  const applications = [
    'Industrial Blanking Tools and Punches',
    'Precision Forming and Trim Dies',
    'Highly Accurate Inspection Gauges',
    'Heavy-Duty Shear Blades',
    'Cold Work Stamping Dies',
    'Medium Wear Resistant Machine Parts',
    'Balanced Toughness Tooling Components'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="32S Tool Steel Forming Dies"
