...
export default function Applications() {
  const applications = [
    ...
    'Standard Tooling Jigs and Fixtures',
    'Cost-Effective Base Plates',
    'Unalloyed Cold Work Tools',
    'Medium-Wear Mechanical Components',
    'Low-Stress Blanking and Forming Dies',
    'Prototype Tooling Templates'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="C45U Pre-machined Tool Steel Plates"
