...
import image from "../../../../assets/images/HighSpeedSteel/M42/image2.png"

export default function Applications() {
  const applications = [
    'Super-Alloy Milling Cutters & Broaches',
    'High-Performance Twist Drills',
    'Precision Industrial Taps & Reamers',
    'Heavy-Duty Bandsaw Blades & Saws',
    'Extreme Hardness Cold Work Tools',
    'Specialized Machining Tools for Aviation',
    'Advanced High-Speed Metal Cutting'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="M42 High Speed Cutting Tools"
