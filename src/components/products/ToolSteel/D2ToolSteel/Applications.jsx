...
import image from "../../../../assets/images/ColdWorkToolSteel/D2/image2.jpg";

export default function Applications() {
  const applications = [
    'Heavy-Duty Press Tools and Punches',
    'Industrial Crushers and Swaging Dies',
    'Thread Rolling and Coining Equipment',
    'High-Abrasion Blanking Tools',
    'Precision Inspection Gauges',
    'General Purpose Machining Dies',
    'Advanced D2 Supreme™ Mold Applications'
  ]
