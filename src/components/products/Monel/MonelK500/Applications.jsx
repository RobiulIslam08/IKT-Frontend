...
export default function Applications() {
  const applications = [
    ...
    'Advanced Electronic Sensors and Components',
    'Chemical Processing and Handling Facilities',
    'Paper Production Machinery',
    'High-Strength Marine and Offshore Fasteners',
    'Pump Shafts and Impeller Tooling',
    'Non-Magnetic Aerospace Instruments'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Monel K500 Oil and Gas Components"
