...
export default function Applications() {
  const applications = [
    'Marine Splash Zone Sheathing and Structural Shafting',
    'Crude Oil Distillation Towers and Equipment',
    'HF Alkylation and MEA Reboiler Systems',
    'Heavy-Duty Oil Well Recovery Pumps',
    'Salt Production and Brine Handling Facilities',
    'Ethyl Chloride Purification Machinery',
    'Industrial Wire Netting and Insulation Systems'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Monel 400 Marine Offshore Components"
