...
export default function Banner() {
	...
	const slides = [
		{
			title: 'ABRASION & WEAR RESISTANT STEEL',
			description:
				'Key Technical Advantages',
			points: [
				'Versatile Hardness Levels: Available in 400, 450, and 500 Brinell (HBW) to match the specific severity of your abrasion environment.',
				'Exceptional Workability: Despite their high surface hardness, our plates are designed to be readily cold-formed, allowing for precise fabrication without specialized equipment.',
			],
