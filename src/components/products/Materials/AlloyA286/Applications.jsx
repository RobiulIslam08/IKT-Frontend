...
export default function Applications() {
  const applications = [
    'Aviation Jet Engine Components and Afterburners',
    'High-Temperature Turbine Wheels and Casings',
    'Industrial Fasteners, Bolts, and Structural Studs',
    'Offshore Oil & Gas High-Pressure Manifolds',
    'Specialized Manifolds and Exhaust Valve Systems',
    'Supercharger and Aftercooler Hardware',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="A286 Stainless Steel Applications" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
