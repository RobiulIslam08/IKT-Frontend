...
import banner1 from "../../../../assets/images/SpeacialAlloys/high_resolution_stainless.jpg";

export default function Banner() {
  const slides = [
    {
      title: 'IKT A286 Stainless Steel (UNS S66286 / Grade 660)',
      description:
        'A286 is an iron-base superalloy designed for applications requiring high strength and corrosion resistance up to 700°C. With superior oxidation resistance and high tensile strength, it is the definitive solution for Saudi Arabia’s aerospace and industrial gas turbine sectors.',
      points: [
        'Elite age-hardenable alloy for high-stress thermal environments.',
        'Exceptional performance in jet engine components and industrial fasteners.',
      ],
