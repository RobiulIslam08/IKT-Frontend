...
export default function Applications() {
  const applications = [
    'Precision Clock and Timing Instruments',
    'Aerospace Composites and Tooling Molds',
    'Laser and Optical Measurement Systems',
    'Cryogenic Components and Liquid Gas Transport',
    'Electronic Circuit Frameworks and Oscillators',
    'High-Stability Scientific Measurement Tools',
    'Thermostatic Bimetal Components'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Invar Alloy Applications" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
    </section>
