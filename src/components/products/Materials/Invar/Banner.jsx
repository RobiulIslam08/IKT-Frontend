...
export default function Banner() {
  const slides = [
    {
      title: 'IKT Invar Alloy (Nickel-Iron Matrix)',
      description:
        'Invar is a unique Nickel-Iron alloy celebrated for its uniquely low coefficient of thermal expansion. It maintains high dimensional stability under varying temperatures, making it indispensable for precision instruments and aerospace tooling in Saudi Arabia.',
      points: [
        'Unmatched dimensional stability from cryogenic levels to 200°C.',
        'Highly resistant to environmental stressors and saltwater corrosion.',
      ],
