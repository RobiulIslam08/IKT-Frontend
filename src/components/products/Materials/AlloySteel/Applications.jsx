...
export default function Applications() {
	const applications = [
		'High-Strength Structural Components and Frames',
		'Gears, Shafts, and Power Transmission Parts',
		'Pressure Vessels and Boiler Components',
		'Aerospace Structural and Engine Components',
		'Mining and Earth-Moving Equipment',
		'Oil and Gas Drilling and Pipeline Components',
		'Heavy-Duty Automotive and Rail Components',
	];
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					>
						<div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
							<img src={image} alt="Alloy Steel Applications" className="w-full h-full object-cover object-center" />
						</div>
					</motion.div>
				</div>
			</div>
