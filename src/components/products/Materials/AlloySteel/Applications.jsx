...
export default function Applications() {
	const applications = [
		'Aerospace Structural Components and Engine Mounts',
		'Oil & Gas High-Pressure Drilling and Piping (ASTM A335)',
		'Automotive Precision Gears, Shafts, and Axles',
		'High-Temperature Boiler and Superheater Tubes (SA213)',
		'Industrial Tooling and Heavy-Duty Machine Parts',
		'Nuclear Power Generation Thermal Structural Hardware',
		'Military Grade Forgings and High-Strength Fasteners'
	]
			...
			<div className="max-w-7xl mx-auto">
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
						<img src={image} alt="Alloy Steel Industrial Usage" className="w-full h-full object-cover object-center" />
					</div>
				</div>
			</div>
