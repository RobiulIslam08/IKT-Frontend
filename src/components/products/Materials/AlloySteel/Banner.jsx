...
import banner1 from "../../../../assets/images/SpeacialAlloys/alloy-steel-suppliers.jpg";

export default function Banner() {
  const slides = [
    {
      title: 'IKT Alloy Steel Solutions (AISI 4140, 4130, 4340)',
      description:
        'IKT provides high-performance Alloy Steel engineered for exceptional strength, toughness, and wear resistance. From AISI 4130 for aerospace to AISI 4140 for heavy-duty industrial gears, we deliver the most reliable metallurgical solutions across Saudi Arabia.',
      points: [
        'Comprehensive inventory of low and high alloy steel pipes and bars.',
        'Precision-matched specifications including AMS, MIL, and ASTM standards.',
      ],
