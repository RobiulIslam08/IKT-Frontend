...
export default function Applications() {
  const applications = [
    'Sulfuric Acid Production and Scrubbing Infrastructure',
    'Chemical Processing Equipment (Mixing Tanks and Valves)',
    'Petrochemical Refining and Desulfurization Units',
    'Pharmaceutical Manufacturing Vessels and Piping',
    'Power Generation and Boiler Feedwater Systems',
    'Plastics Manufacturing and Dye Production Lines',
    'Food Processing and Acid-Based Cleaning Stations'
  ]
