...
export default function Applications() {
	const applications = [
		'Oil & Gas Pipeline Infrastructure (API 5L & ASTM A106)',
		'High-Temperature Boiler and Superheater Tubes',
		'Automotive Chassis, Axles, and Forged Components',
		'Structural Construction and Civil Engineering Frameworks',
		'Industrial Fasteners, Edged Tools, and High-Strength Wires',
		'Pressure Vessels and Petrochemical Piping Systems',
		'Power Plant Exhaust and Condenser Lines'
	]
			...
			<div className="max-w-7xl mx-auto">
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
						<img src={image} alt="Carbon Steel Industrial Usage" className="w-full h-full object-cover object-center" />
					</div>
				</div>
			</div>
