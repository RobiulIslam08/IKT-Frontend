...
export default function Applications() {
	const applications = [
		'Structural Steel Frames and Fabrications',
		'Shafts, Axles, and Machine Components',
		'Automotive Body Panels and Chassis Parts',
		'Pipelines and Pressure Vessels',
		'Agricultural and Construction Equipment',
		'Cutting Tools and Wear Parts (High Carbon)',
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					>
						<div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
							<img src={image} alt="Carbon Steel Applications" className="w-full h-full object-cover object-center" />
						</div>
					</motion.div>
				</div>
			</div>
