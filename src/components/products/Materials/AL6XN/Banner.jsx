...
export default function Banner() {
  const slides = [
    {
      title: 'IKT AL-6XN Stainless Steel (UNS N08367)',
      description:
        'AL-6XN is a super-austenitic stainless steel engineered for extreme resistance to chloride pitting and crevice corrosion. With high nitrogen content and 6% Molybdenum, it is the definitive solution for Saudi Arabia\'s desalination plants and marine saltwater systems.',
      points: [
        'Elite resistance to stress corrosion cracking in aggressive halide media.',
        'Superior tensile strength compared to standard 300-series stainless steels.',
      ],
