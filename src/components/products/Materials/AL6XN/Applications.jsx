...
export default function Applications() {
  const applications = [
    'Desalination Plant Evaporators and Brine Concentrators',
    'Offshore Oil & Gas Platform Seawater Piping',
    'Marine Saltwater Heat Exchangers and Condensers',
    'Petrochemical Chemical Process Tanks and Vessels',
    'Flue Gas Desulfurization (FGD) Scrubber Systems',
    'High-Purity Pharmaceutical Processing Equipment',
    'Pulp and Paper Bleaching Plant Components'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="AL-6XN Super Austenitic Applications" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
