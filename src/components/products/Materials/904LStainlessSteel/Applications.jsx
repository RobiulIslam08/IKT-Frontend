...
export default function Applications() {
  const applications = [
    'Seawater Cooling Equipment and Desalination Systems',
    'Sulfuric, Phosphoric, and Acetic Acid Processing Plants',
    'Chemical Tankers and Marine Scrubbing Infrastructure',
    'Oil Refinery Components (Heat Exchangers and Condensers)',
    'Pulp and Paper Industry Bleaching Infrastructure',
    'Gas Scrubbing Equipment for Flue Gas Desulfurization',
    'High-Precision Pharmaceutical Reaction Vessels'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="904L Stainless Steel Applications"
