...
export default function Applications() {
  const applications = [
    'Large-Scale Desalination and Saltwater Handling Plants',
    'Flue Gas Desulfurization Scrubbers and Cleaning Systems',
    'Offshore Petroleum Production and Tall Oil Distillation',
    'High-Chloride Chemical Processing Equipment',
    'Pulp and Paper Industry Bleaching Infrastructure',
    'Corrosive Environment Heat Exchangers',
    'Heavy-Duty Food Processing Machinery'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="254 SMO Desalination Equipment"
