...
export default function Banner() {
  const slides = [
    {
      title: 'IKT EN Standard Steel Solutions',
      description:
        'European Standards (EN) are the backbone of the Single European Market, ensuring high-quality steel production. IKT provides a vast range of EN-certified Carbon, Alloy, Stainless, and Tool steels, perfectly cross-referenced with SAE, DIN, and JIS standards for Saudi Arabia’s industrial needs.',
      points: [
        'Full compliance with CEN, CENELEC, and ETSI standardization frameworks.',
        'Precision equivalence mapping for EN19, EN24, and high-grade stainless steels.',
      ],
