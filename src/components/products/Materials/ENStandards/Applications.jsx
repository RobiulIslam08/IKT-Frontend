...
export default function Applications() {
  const applications = [
    'Automotive Gear and Shaft Production (EN19 / EN24)',
    'Construction and Infrastructure Frameworks (Carbon Steels)',
    'High-Stakes Petrochemical Piping (EN Stainless Series)',
    'Precision Tool and Die Manufacturing (EN Tool Steels)',
    'Food and Pharmaceutical Processing (304/316 Stainless)',
    'Heavy Machinery and Power Generation Components',
    'Marine Engineering and Desalination Infrastructure'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="EN Standard Steel Industrial Usage" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
