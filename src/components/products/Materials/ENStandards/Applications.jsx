...
export default function Applications() {
	const applications = [
		'Pressure Vessels and Heat Exchangers (EN 10028)',
		'Structural Steel Fabrications (EN 10025)',
		'Stainless Steel Equipment and Pipework (EN 10088)',
		'Nickel Alloy Components for High-Temperature Service',
		'Power Generation and Nuclear Industry Components',
		'Oil, Gas, and Petrochemical Plant Equipment',
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					>
						<div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
							<img src={image} alt="EN Standards Applications" className="w-full h-full object-cover object-center" />
						</div>
					</motion.div>
				</div>
			</div>
