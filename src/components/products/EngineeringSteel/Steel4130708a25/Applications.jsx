...
import image from "../../../../assets/images/QuencedAndTempered/Steel4130-708A25/image2.png"

export default function Applications() {
  const applications = [
    'Specialized Aircraft & Airframe Components',
    'Oil Patch & Gas Industry Equipment',
    'Automotive Connecting Rods & Axles',
    'High-Pressure Hydraulic Lines & Fittings',
    'Engine Mounting Lugs & Bushes',
    'Nitrided Machinery Gears & Shafts',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="AISI 4130 Aircraft and Automotive Components"
