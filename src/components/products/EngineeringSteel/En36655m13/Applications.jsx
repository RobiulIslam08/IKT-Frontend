...
export default function Applications() {
  const applications = [
    ...
    'High-Wear Mechanical Cams',
    'Deep-Hardened Steel Rollers',
    'Automotive Transmission Components',
    'High-Impact Drive Mechanisms',
    'Case-Hardened Machined Parts',
    'High-Stress Core Engineering Shafts'
  ]
