...
export default function Applications() {
  const applications = [
    ...
    'High Shock-Resistant Components',
    'Ductile Engineering Parts',
    'Hard Chrome Plated Rods (EN14A variants)',
    'Automotive and Agricultural Machinery',
    'General Mechanical Spindles & Axles',
    'Medium Tensile Fasteners and Shafts'
  ]
