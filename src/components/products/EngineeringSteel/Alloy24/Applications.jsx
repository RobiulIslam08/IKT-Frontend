...
export default function Applications() {
  const applications = [
    'General Machine Construction & Parts',
    'Heavy-Duty Guide Rails and Base Plates',
    'Industrial Folding & Plate Forming Tools',
    'High-Friction Wear Components',
    'Precision Rubber & Die Casting Moulds',
    'Robust Assembling Modules',
    'Large-Scale EN24T Alternatives'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="ALLOY24 Die Casting and Mould Parts"
