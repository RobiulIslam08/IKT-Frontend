...
export default function Applications() {
  const applications = [
    ...
    'Heavy-Duty Industrial Nuts',
    'Mechanical Drive Shafts',
    'Automotive and Machinery Axles',
    'Shock-Resistant Engineering Components',
    'General Machined Parts',
    'High-Stress Structural Spindles'
  ]
