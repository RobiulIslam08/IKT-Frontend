...
export default function Applications() {
  const applications = [
    ...
    'Fixed Heavy-Duty Structural Frameworks',
    'High Payload Transport Vehicles',
    'Earthmoving and Mining Machinery',
    'High Yield Quenched & Tempered Plates',
    'High Strength Low Alloy (HSLA) Structures',
    'Lightweight Offshore Steel Constructions'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="S690QL High Yield Structural Crane"
