...
export default function Applications() {
  const applications = [
    'High-Strength Transmission Gears',
    'Heavy-Duty Mechanical Shafts',
    'High-Tensile Studs and Bolts',
    'Surface-Hardened Wear Components',
    'Automotive and Aerospace Fasteners',
    'Industrial Spindles and Axles',
    'Nitrided or Induction Hardened Parts'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="EN24T Heavy Duty Gears and Shafts"
