...
export default function Applications() {
  const applications = [
    'Low-stress engineering parts',
    'Machined shafts, pins, and studs',
    'Custom cut, drilled, or fabricated items',
    'General fabrication and welding projects',
    'Case hardened components for improved wear',
    'Bright drawn or hot rolled engineering solutions',
    'Bespoke orders delivered nationwide by IKT'
  ]
