...
export default function Applications() {
  const applications = [
    'Automatic and CNC machining operations',
    'Intricate drilling and turning work',
    'Bright drawn precision components',
    'Screws, bolts, studs, and fasteners',
    'High-volume production of turned parts',
    'Custom cut rounds, squares, flats, hexagons',
    'Unleaded and leaded forms available from IKT'
  ]
