...
export default function Applications() {
  const applications = [
    'Heavy-Duty Automotive Gears',
    'High-Strength Drive Shafts & Axles',
    'Industrial Spindles and Pinions',
    'Wear-Resistant Mechanical Components',
    'Hard Chrome Plated Rods (EN19T)',
    'Pre-Machined Engineering Parts',
    'Custom High-Tensile Steel Forgings'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="EN19 High Tensile Steel Applications"
