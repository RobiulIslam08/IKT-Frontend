...
export default function Applications() {
  const applications = [
    'Automated CNC Machining Projects',
    'High-Speed Repetitive Lathe Work',
    'Precision Turned Fasteners and Fittings',
    'Intricate Component Manufacturing',
    'Lightly Stressed Engineering Parts',
    'Mass Production of Hardware',
    'Custom Profile Milling and Turning'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Industrial CNC Machining Process"
