...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'Germany (DIN / W.Nr.)', grade: '1.2344' },
    { standard: 'DIN Specification', grade: 'DIN 17350-1980' },
    { standard: 'Material Category', grade: 'Hot Work Tool Steel' }
  ];

  const chemicalData = [
    { element: 'Carbon (C)', content: '0.37 - 0.42' },
    { element: 'Chromium (Cr)', content: '4.80 - 5.50' },
    { element: 'Molybdenum (Mo)', content: '1.20 - 1.50' },
    { element: 'Vanadium (V)', content: '0.90 - 1.10' },
    { element: 'Silicon (Si)', content: '0.90 - 1.20' },
    { element: 'Manganese (Mn)', content: '0.30 - 0.50' },
    { element: 'Phosphorus (P)', content: '≤ 0.030' },
    { element: 'Sulfur (S)', content: '≤ 0.030' }
  ];

  const mechanicalData = [
    { property: 'Firmness / Strength', value: '> 1765 N/mm²' },
    { property: 'Hardenability Depth', value: 'Up to 150 mm (Diameter)' },
    { property: 'Wear & Tempering Resistance', value: 'Excellent' }
  ];

  const physicalData = [
    { property: 'Thermal Stability', value: 'Maintains firmness during heating' },
    { property: 'Cooling Suitability', value: 'Compatible with water-cooled tools' },
    { property: 'Workability (Heated)', value: 'Well-workable' },
    { property: 'Workability (Soft-Annealed)', value: 'Well-workable' }
  ];
  ...
  const processingSteps = [
    { process: "Die Casting & Extrusion", details: "Extensively used in die casting dies for aluminum, magnesium, and zinc. Also serves as extrusion dies for aluminum and brass, including liners, mandrels, and pressure pads." },
    { process: "Hot Work Tooling", details: "Ideal for plastic moulds, shear blades for hot work, hot swaging dies, hot stamping, press forge dies, split hot heading dies, gripper dies, and piercing tools." },
    { process: "Machining & Sizing", details: "Available as ground flat stock or gauge plate. Round bars and flat sections can be custom sawn and precision ground to tight tolerances according to exact specifications." }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT 1.2344 Hot Work Tool Steel chemistry, mechanical limits, and international supply standards.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            1.2344 Hot Work Tool Steel components, including precision ground round bars, thick hot-rolled plates, and customized blocks, are heavily stocked across Saudi Arabia to support rapid die-casting and hot forging tooling deployment.
          </p>
          <p className="text-base font-medium text-gray-600">
            For critical procurement inquiries, structural sizing details, or exact DIN material certifications, please contact our expert engineering team in Saudi Arabia at <span className="font-bold text-primary">+966-13-3444036</span>.
          </p>
        </motion.div>
