...
import image from "../../../../assets/images/HotWorkToolSteel/steel1.2344/image2.png";
...
export default function Applications() {
  const applications = [
    ...
    'Hot Swaging and Piercing Tools',
    'Heavy-Duty Mandrels and Pressure Pads',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="1.2344 Hot Forging and Die Casting Tools"
