...
import image from "../../../../assets/images/HotWorkToolSteel/skd61/image2.jpg";

export default function Applications() {
  const applications = [
    'Die Casting Dies (Aluminum, Magnesium, Zinc)',
    'Aluminum and Brass Extrusion Tooling',
    'Hot Stamping and Press Forge Dies',
    'Split Hot Heading and Gripper Dies',
    'High-Resistance Plastic Injection Moulds',
    'Heavy-Duty Extrusion Liners and Mandrels',
    'Hot Work Shear Blades and Swaging Dies'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="SKD61 Hot Work Die Casting Tools"
