...
import image from "../../../../assets/images/HotWorkToolSteel/x40cr/image2.jpg"

export default function Applications() {
  const applications = [
    'Die Casting Dies (Aluminum, Magnesium, Zinc)',
    'Aluminum and Brass Extrusion Tooling',
    'Hot Forging and Press Forge Dies',
    'Extrusion Liners, Mandrels, and Pressure Pads',
    'Heavy-Duty Hot Swaging and Piercing Tools',
    'Thick Wall Plastic Injection Moulds',
    'High-Endurance Shear Blades for Hot Work'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="X40CrMoV5-1 Hot Forging Tools"
