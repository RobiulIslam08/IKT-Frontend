...
export default function Applications() {
  const applications = [
    'Aircraft Airframes and High-Strength Aviation Components',
    'Commercial Transportation and Automotive Chassis Parts',
    'Medical Assembly and Specialized Laboratory Hardware',
    'Architectural Structural Components and DIY Designs',
    'Industrial Machinery Frameworks and Protective Casings',
    'Consumer Goods, Appliances, and Electronic Enclosures',
    'Petrochemical Heat Management and Thermal Shielding'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Aluminium Alloy Industrial Usage" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
    </section>
