...
export default function Banner() {
  const slides = [
    {
      title: 'IKT Aluminium Based Alloy Solutions',
      description:
        'Aluminium is the ultimate lightweight engineering material. Known for its high strength-to-weight ratio and exceptional recyclability, it is essential for Saudi Arabia’s aerospace, commercial transportation, and modern architectural sectors.',
      points: [
        'Superior corrosion resistance and high formability for industrial jobs.',
        '100% recyclable and environmentally friendly structural solution.',
      ],
