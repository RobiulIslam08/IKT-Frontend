...
export default function Banner() {
  const slides = [
    {
      title: 'IKT Stainless Steel Solutions',
      description:
        'Stainless steel is a versatile family of corrosion-resistant alloys containing at least 10.5% Chromium. Engineered to form a self-healing passive layer, it is the premier choice for Saudi Arabia’s construction, chemical processing, and maritime infrastructure.',
      points: [
        'Exceptional resistance to atmospheric, acidic, and chloride environments.',
        'High-performance grades for extreme temperature and pressure conditions.',
      ],
