...
export default function Applications() {
  const applications = [
    'Aerospace Jet Engine Components and Afterburners',
    'Gas Turbine Engines for Power Generation and Waste Incineration',
    'Chemical Processing Vessels and Heat Exchangers',
    'Offshore Sour Gas Production and Subsea Infrastructure',
    'Hazardous Waste Treatment and Emissions Control Systems',
    'High-Purity Pharmaceutical and Biotech Vessels',
    'Industrial Heating Equipment and Thermal Retorts'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Nickel Alloy Industrial Usage" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
