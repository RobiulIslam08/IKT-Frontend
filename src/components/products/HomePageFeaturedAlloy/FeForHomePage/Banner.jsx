...
export default function Banner() {
  const slides = [
    {
      title: 'IKT Invar Round Bar (UNS K93600 / Invar 36®)',
      description:
        'Invar 36® is a specialized nickel-iron alloy engineered for ultra-low thermal expansion. It maintains high dimensional stability—expanding at only one-tenth the rate of carbon steel—making it the essential choice for Saudi Arabia\'s aerospace and precision electronics.',
      points: [
        'Minimal dimensional changes from cryogenic levels to 204°C.',
        'Superior performance in sensitive sensors and aeronautical packages.',
      ],
