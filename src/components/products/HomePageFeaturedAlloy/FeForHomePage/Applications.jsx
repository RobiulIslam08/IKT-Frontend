...
export default function Applications() {
  const applications = [
    'Precision Measurement and Metrology Devices',
    'Telecommunications Sensor and Electronic Packaging',
    'Aeronautical and Aerospace Structural Rods',
    'Cryogenic Components and Liquid Gas Transport',
    'Thermostatic Bimetal Components for Thermal Motion',
    'Laser and Optical System Frameworks',
    'High-Stability Electronic Oscillator Components'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Invar Round Bar Applications" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
    </section>
