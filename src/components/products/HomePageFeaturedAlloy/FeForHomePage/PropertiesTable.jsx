...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    ...
    { standard: 'ASTM Specification', grade: 'ASTM F1684' },
    { standard: 'Military Spec', grade: 'MIL-1-23011' },
  ...
  const thermalData = [
    ...
    { property: 'Thermal Expansion Rate', value: '1/10th of Carbon Steel' },
    { property: 'Expansion Stability Range', value: 'Up to 400°F (204°C)' },
    { property: 'Material Basis', value: 'Nickel-Iron Matrix' }
  ];
  ...
  const supplyFormats = [
    ...
    { form: 'Invar Wire', specs: 'High-Precision Electronic Grade' },
    { form: 'Machined Components', specs: 'Bespoke Aerospace Hardware' }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 text-center">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT Invar 36 (UNS K93600) chemical matrix, expansion benchmarks, and industrial certifications.</p>
        </div>
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full">
            <div className="bg-primary/10 px-6 py-4 border-b border-gray-200 text-center">
              <h3 className="text-xl font-bold text-gray-800">Controlled Expansion Benchmark</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200 text-center">
                    ...
                    <th className="px-6 py-4 font-bold w-1/2">Technical Value</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <div className="mt-12 p-8 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            Invar 36® structural components, including precision round bars, aerospace-grade billet stock, and structural rods, are heavily stocked across Saudi Arabia to empower rapid deployment in telecommunications and defense sectors.
          </p>
