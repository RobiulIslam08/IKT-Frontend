          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">Unmatched Dimensional Stability</h2>
                <p className="text-base font-medium text-gray-700 leading-relaxed">
                  Invar 36® (UNS K93600) is a unique 36% nickel-iron alloy designed for applications where dimensional changes due to temperature fluctuation must be minimized. It boasts a rate of thermal expansion roughly one-tenth that of standard carbon steel at temperatures up to 400°F (204°C). This stability makes it critical for Saudi Arabia\'s specialized electronic packaging and aeronautical instrumentation.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-base font-medium text-gray-700 leading-relaxed">
                  Available in Billet, Rod, and Bar formats, Invar 36 is often used in conjunction with high-expansion alloys to generate precise mechanical motion upon temperature change. Whether used for precision clock balances or cryogenic structural rods, its metallurgical profile ensures that sensitive electronic packages in telecommunications remain perfectly aligned and operational under fluctuating environmental stress.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex-1 text-left">
                <h2 className="text-2xl font-bold text-gray-900 mb-3">Certified Global Supply in KSA</h2>
                <p className="text-base font-medium text-gray-700 leading-relaxed">
                  IKT holds a certified inventory of Invar 36 products strictly compliant with ASTM F1684, AMS 23011, and MIL-1-23011 standards. We provide fully traceable forms, including precision round bars, billet stock, and industrial rods. Sourced from globally recognized manufacturers, our supply chain ensures full compliance with UNS K93603 specifications for rapid deployment in the Kingdom\'s high-stakes precision sectors.
                </p>
              </div>
            </div>
          </div>
