...
export default function Applications() {
  const applications = [
    'Electrical Wiring and Power Distribution Components',
    'Marine Desalination Plant Heat Exchangers and Condensers',
    'Offshore Oil & Gas Biofouling Resistant Infrastructure',
    'Cryogenic Gas Transport and Storage Vessels',
    'Industrial High-Precision Machined Hardware',
    'Aeronautical Non-Magnetic Instrumentation',
    'Brazed and Soldered Structural Assemblies'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Copper Alloy Industrial Usage" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
    </section>
