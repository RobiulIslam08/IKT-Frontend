...
export default function Banner() {
  const slides = [
    {
      title: 'IKT Copper Based Alloy Solutions',
      description:
        'Copper alloys are the gold standard for electrical and thermal conductivity. Known for their superior corrosion resistance and non-magnetic properties, they are essential for Saudi Arabia’s energy, marine, and cryogenics industries.',
      points: [
        'Elite heat and electrical conductivity for industrial frameworks.',
        'Outstanding biofouling resistance and cryogenic property retention.',
      ],
