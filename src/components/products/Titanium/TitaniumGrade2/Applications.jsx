...
export default function Applications() {
  const applications = [
    'Chemical Processing and Desalination Plant Components',
    'Sour Gas Service and Oil Patch Environments (NACE Compliant)',
    'Marine Engineering (Saltwater Condensers and Heat Exchangers)',
    'Aerospace Transition Ducts and Structural Assemblies',
    'Petrochemical Hydrocarbon Processing and Retorts',
    'Architectural and Marine Decorative Structures',
    'High-Stakes Waste and Water Treatment Infrastructure'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="CP Grade 2 Titanium Industrial Usage"
