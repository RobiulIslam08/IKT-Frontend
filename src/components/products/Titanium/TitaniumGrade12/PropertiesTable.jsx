...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'UNS Designation', grade: 'R53400' },
    { standard: 'Germany (Werkstoff Nr.)', grade: '3.7105' },
    { standard: 'Trade Names', grade: 'Ti-CODE 12™, Ti-0.3Mo-0.8Ni' },
    { standard: 'Certification', grade: 'PED Approved Manufacturer' }
  ];

  const chemicalData = [
    { element: 'Titanium (Ti)', content: 'Balance (Remainder)' },
    { element: 'Nickel (Ni)', content: '0.60 - 0.90' },
    { element: 'Molybdenum (Mo)', content: '0.20 - 0.40' },
  ...
  const mechanicalData = [
    { property: 'Ultimate Tensile Strength', value: '550 MPa (79,800 psi)' },
    { property: 'Yield Strength (0.2% Offset)', value: '380 MPa (55,100 psi)' },
    { property: 'Density', value: '4.50 g/cm³ (0.163 lb/in³)' },
    { property: 'Elongation at Break', value: '18.0 - 22.0 %' },
    { property: 'Modulus of Elasticity', value: '105 GPa (15,200 ksi)' },
    { property: 'Poisson’s Ratio', value: '0.37' }
  ];

  const hardnessData = [
    { scale: 'Rockwell C Hardness', value: '11 HRC' },
    { scale: 'Brinell Hardness', value: '180 - 235 HB' },
    { scale: 'Vickers Hardness', value: '209 HV' },
    { scale: 'Knoop Hardness', value: '222 HK' }
  ];

  const thermalData = [
    { property: 'Melting Point (Approx.)', value: '1660 °C (3020 °F)' },
    { property: 'Shear Modulus', value: '45.0 GPa (6,530 ksi)' },
    { property: 'Crevice Corrosion resistance', value: 'High' }
  ];

  const pricingData = [
    { origin: 'Indian Origin (Grade 12 Ti)', price: 'Rs 5500 / $80 / €68' },
    { origin: 'Japanese Origin (R53400 Alloy)', price: 'Rs 6200 / $91 / €78' },
    { origin: 'European Origin (3.7105 Material)', price: 'Rs 6900 / $101 / €87' },
    { origin: 'USA Origin (Ti-CODE 12™)', price: 'Rs 7500 / $110 / €94' }
  ];

  const supplyFormats = [
    { form: 'Grade 12 Seamless Pipe', specs: 'ASME SB-337 / SB-338' },
    { form: 'Grade 12 Instrumentation Tubing', specs: 'High-Temperature Seamless' },
    { form: 'Grade 12 Industrial Plates', specs: 'Custom Cut-to-Size' },
    { form: 'Grade 12 Sheets & Coils', specs: 'High Corrosion Stability' },
    { form: 'Grade 12 Forged Parts', specs: 'Fittings and Flanges' }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 text-center">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT Titanium Grade 12 (UNS R53400) chemical analysis, mechanical limits, and international price benchmarks.</p>
        </motion.div>
        ...
        <div className="flex flex-col gap-10">
          ...
          {/* 4. Hardness Benchmarks */}
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full">
            <div className="bg-primary/10 px-6 py-4 border-b border-gray-200 text-center">
              <h3 className="text-xl font-bold text-gray-800">Titanium Grade 12 Hardness Benchmarks</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200 text-center">
                    <th className="px-6 py-4 font-bold border-r border-gray-100 w-1/2">Hardness Scale</th>
                    <th className="px-6 py-4 font-bold w-1/2">Value</th>
                  </tr>
                </thead>
                <tbody>
                  {hardnessData.map((row, index) => (
                    <tr key={index} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors text-center">
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base border-r border-gray-100 w-1/2">{row.scale}</td>
                      <td className="px-6 py-4 text-center text-gray-700 font-medium text-base w-1/2">{row.value}</td>
                    </tr>
                  ))}
                </tbody>
        ...
        <motion.div variants={itemVariants} className="mt-12 p-8 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            Titanium Grade 12 (Ti-0.3Mo-0.8Ni) structural materials, including heavy industrial plates, pressure vessels, and specialized airframe components, are extensively stocked across Saudi Arabia to support rapid deployment in severe corrosion and high-temperature environments.
          </p>
