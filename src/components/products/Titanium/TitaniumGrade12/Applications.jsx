...
export default function Applications() {
  const applications = [
    'Chemical Processing Vessels with High-Temperature Requirements',
    'Heat Exchangers and Condensers in Crevice-Corrosion Prone Areas',
    'Aerospace Airframe and Engine Components',
    'Marine Engineering and Offshore Saltwater Infrastructure',
    'Hydrometallurgical Processing and Brine Evaporators',
    'High-Performance Industrial Piping for Corrosive Media',
    'Petrochemical Refining Equipment and Pressure Vessels'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Titanium Grade 12 Applications"
