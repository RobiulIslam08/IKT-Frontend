...
export default function Applications() {
  const applications = [
    ...
    'Desalination Brine Concentrators and Evaporators',
    'Industrial Heat Exchangers and Steam Condensers',
    'Offshore Oil & Gas Components in Aggressive Chloride Zones',
    'Marine Engineering Instrumentation and Fittings',
    'High-Stakes Waste and Water Treatment Systems',
    'Biomedical Surgical Devices Requiring High Ductility'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Titanium Grade 11 Applications"
