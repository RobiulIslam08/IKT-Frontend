...
export default function Applications() {
  const applications = [
    'Desalination Plant Brine Concentrators and Evaporators',
    'Chemical Processing Vessels Handling Hydrochloric & Sulfuric Acids',
    'Offshore Oil & Gas Components in High-Chloride Zones',
    'Petrochemical Heat Exchangers and Condenser Systems',
    'Pulp and Paper Bleaching Infrastructure',
    'Specialized Marine Fasteners, Flanges, and Pipe Fittings',
    'Waste Treatment Systems for Severe Corrosive Media'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Grade 7 Titanium Applications"
