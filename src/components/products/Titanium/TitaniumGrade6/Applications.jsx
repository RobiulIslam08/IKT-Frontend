...
export default function Applications() {
  const applications = [
    'Gas Turbine Engine Transition Ducts and Afterburners',
    'Structural Airframe Components and Aviation Forgings',
    'High-Temperature Petrochemical Retorts and Vessels',
    'Chemical Processing Equipment for Prolonged Heat Exposure',
    'Precision Aerospace Hardware (Fasteners and Fixings)',
    'Cryogenic Application Components and Structural Supports',
    'Industrial Heat Exchangers and Steam Condensers'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Titanium Grade 6 Applications"
