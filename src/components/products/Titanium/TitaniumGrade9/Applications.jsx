...
export default function Applications() {
  const applications = [
    'High-Pressure Aerospace Hydraulic Piping Systems',
    'Offshore Oil & Gas Subsea Flowlines and Risers',
    'Chemical Processing Heat Exchangers and Condensers',
    'Medical Structural Fixations and Surgical Implants',
    'Petrochemical Infrastructure in Sour Gas Environments',
    'High-Performance Bicycle Frames and Sporting Goods',
    'Marine Saltwater Brine Transfer Systems'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Grade 9 Titanium Applications"
