...
export default function Applications() {
  const applications = [
    'Aerospace Engine Turbines and Structural Airframe Parts',
    'Biomedical Surgical Implants and Prosthetic Components',
    'Offshore Oil & Gas Equipment and Subsea Hardware',
    'High-Performance Automotive Parts and Exhaust Systems',
    'Marine Desalination Plant High-Pressure Components',
    'Chemical Processing Vessels and Corrosive Media Linings',
    'Defense Sector Armor Plates and Ballistic Protection'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Ti-6AL-4V Grade 5 Titanium Usage"
