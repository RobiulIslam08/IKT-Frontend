...
export default function Applications() {
  const applications = [
    'Medical Implants and Surgical Fixation (Grade 23 & Grade 4)',
    'Aerospace Aircraft Frames and Jet Engine Parts (Grade 5)',
    'Chemical Processing Heat Exchangers (Grade 7 & Grade 12)',
    'Offshore Oil & Gas Desalination Piping and Brine Tanks',
    'Marine Subsea ROV and Submarine Components',
    'Automotive Racing Exhaust and Performance Hardware',
    'High-Stakes Industrial Welding and Fabrications'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Titanium Alloy Applications" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
    </section>
