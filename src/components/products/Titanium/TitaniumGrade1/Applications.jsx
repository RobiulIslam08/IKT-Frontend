...
export default function Applications() {
  const applications = [
    ...
    'Desalination Plant Heat Exchangers and Condensers',
    'Marine Engineering Components and Offshore Infrastructure',
    'Aviation Airframe Parts and Precision Fasteners',
    'Industrial Piping Systems for Highly Acidic Fluids',
    'Power Generation Condenser Tubing and Fittings',
    'Medical Implants and Specialized Surgical Hardware'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="CP Grade 1 Titanium Industrial Usage"
