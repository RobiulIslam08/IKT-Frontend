...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'UNS Designation', grade: 'R50550' },
    { standard: 'Germany (Werkstoff Nr.)', grade: '3.7055 / 3.7054' },
    { standard: 'Trade/Specs', grade: 'CP GRADE 3, MIL-T-9046 CP2, AMS 4900' },
    { standard: 'British/Other', grade: '904S13, T50, DTD 5023' }
  ];

  const chemicalData = [
    { element: 'Titanium (Ti)', content: '99.1 Minimum' },
    { element: 'Iron (Fe)', content: '≤ 0.30' },
    { element: 'Oxygen (O)', content: '≤ 0.35' },
  ...
  const mechanicalData = [
    { property: 'Ultimate Tensile Strength', value: '440 MPa (63,800 psi)' },
    { property: 'Yield Strength (0.2% Proof)', value: '310 - 410 MPa' },
    { property: 'Density', value: '4.5 g/cm³ (0.163 lb/in³)' },
    { property: 'Modulus of Elasticity', value: '105 GPa' },
    { property: 'Hardness (Typical)', value: 'Brinell 180 - 200' },
    { property: 'Biocompatibility', value: 'Surgical Implant Grade (ASTM F67)' }
  ];

  const thermalData = [
    { property: 'Melting Point', value: '1670 °C (3038 °F)' },
    { property: 'Boiling Point', value: '3287 °C (5949 °F)' },
    { property: 'Thermal Conductivity', value: '17 W/m·K' },
    { property: 'Specific Heat Capacity', value: '520 J/kg·K' }
  ];

  const pricingData = [
    { origin: 'Indian Origin (Titanium CP2 Gr 3)', price: 'Rs 1300 / $18 / €16' },
    { origin: 'Japanese Origin (Ti CP Grade 3)', price: 'Rs 1600 / $24 / €20' },
    { origin: 'European Origin (Titan Grade 3)', price: 'Rs 1750 / $26 / €22' },
    { origin: 'USA Origin (R50550 / AMS 4900)', price: 'Rs 1800 / $27 / €23' }
  ];

  const supplyFormats = [
    { form: 'Sheets, Strips & Plates', specs: 'AMS 4900 / MIL-T-9046J' },
    { form: 'Heat Exchanger Tubing', specs: 'ASTM B338 / ASME SB-338' },
    { form: 'Solid Rods & Bars', specs: 'ASTM B348 / ASME SB-348' },
    { form: 'Forgings & Castings', specs: 'ASTM B381 / ASTM B367' },
    { form: 'Precision Bolts & Fasteners', specs: 'ASTM F467 / ASTM F468' }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 text-center">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT CP Grade 3 Titanium (R50550) metallurgical analysis, aerospace specifications, and global pricing.</p>
        </motion.div>
        ...
        <div className="flex flex-col gap-10">
          ...
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full text-left">
            <div className="bg-primary/10 px-6 py-4 border-b border-gray-200 text-center">
              <h3 className="text-xl font-bold text-gray-800">CP Grade 3 Titanium Price Index (Per Kg)</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
        ...
        <motion.div variants={itemVariants} className="mt-12 p-8 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            Grade 3 Titanium structural components, including aerospace-certified sheets (AMS 4900), medical implants (ASTM F67), and desalination condenser tubes, are heavily stocked across Saudi Arabia. We provide PED-approved high-quality stock with full metallurgical certification for aviation and healthcare deployment.
          </p>
