...
export default function Applications() {
  const applications = [
    'Aerospace Airframe Components and Transition Ducts',
    'High-Strength Surgical Implants and Medical Fixations',
    'Chemical Processing Vessels requiring Moderate Strength',
    'Marine Desalination Heat Exchanger Tubing',
    'High-Performance Industrial Piping and Fittings',
    'Gas Turbine Components and Structural Exhaust Liners',
    'Corrosive Environment Fasteners (Bolts and Nuts)'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Grade 3 Titanium Industrial Usage"
