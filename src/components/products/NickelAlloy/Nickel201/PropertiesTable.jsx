...
export default function PropertiesTable() {
  ...
  const physicalData = [
    ...
    { property: 'Modulus of Elasticity', value: '30,000 ksi (207 kN/mm²)' },
    { property: 'Modulus of Rigidity', value: '11,893 ksi (82 kN/mm²)' },
    { property: 'Linear CTE', value: '13.1 µm/m-°C' },
    { property: 'Curie Temperature', value: '360 °C (680 °F)' }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 text-center">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT Nickel Alloy 201 chemistry, electrical dynamics, and rigorous ASTM supply standards.</p>
        </motion.div>
        ...
        <div className="flex flex-col gap-10">
          ...
          {/* 4. Physical & Electrical Dynamics Table */}
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full">
            <div className="bg-primary/10 px-6 py-4 border-b border-gray-200 text-center">
              <h3 className="text-xl font-bold text-gray-800">Physical & Electrical Dynamics</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
          ...
          {/* 6. Engineering & Application Profile */}
