...
export default function Applications() {
  const applications = [
    'Battery Terminals and Advanced Electrical Components',
    'Heating Element Lead Wires and Electronic Shielding',
    'High-Temperature Synthetic Fiber Processing Machinery',
    'Food Processing and Handling Equipment',
    'Aerospace Instrumentation and Structural Parts',
    'Caustic Evaporators and Alkali Production Vessels',
    'Combustion Boats and Plating Racks'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Nickel 201 Electronic Components"
