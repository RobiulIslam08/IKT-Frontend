...
export default function Applications() {
  const applications = [
    ...
    'High-Performance Electrical and Electronic Components',
    'Chemical Shipping Drums and Storage Vessels',
    'Food Processing and Synthetic Fiber Machinery',
    'Aerospace and Defense Missile Components',
    'Salt Production and Brine Handling Systems',
    'Critical Structural Marine Hardware'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Nickel 200 Chemical Processing Components"
