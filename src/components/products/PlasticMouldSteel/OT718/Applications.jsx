...
export default function Applications() {
  const applications = [
    'Large-Scale Plastic Injection Moulds',
    'High-Grade Plastic Forming Parts',
    'Long-Run Tooling (Up to 1,000,000 cycles)',
    'Alkali-Resistant Nitrided Mould Components',
    'Heavy-Duty Pre-Hardened Die Bases',
    'Intricate Cavity Sinking Tooling',
    'Automotive Bumper and Dashboard Moulds'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="OT718 Plastic Injection Moulds"
