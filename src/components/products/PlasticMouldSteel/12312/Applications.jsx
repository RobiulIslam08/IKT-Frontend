...
import image from "../../../../assets/images/PlasticMouldSteel/Steel1.2312/image1.png"

export default function Applications() {
  const applications = [
    'Automotive Injection Moulding Components',
    'PVC and PP Plastic Injection Moulds',
    'Large-Scale Plastic Steel Mould Bases',
    'High-Machinability Intricate Mould Cavities',
    'Moulds Requiring Chrome Surface Treatments',
    'Pre-Hardened Die Bases and Frames',
    'High-Volume Consumer Goods Tooling'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="1.2312 Plastic Injection Moulds"
