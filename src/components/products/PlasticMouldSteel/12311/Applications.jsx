...
import image from "../../../../assets/images/PlasticMouldSteel/Steel1.2311/image2.png"

export default function Applications() {
  const applications = [
    'High-Quality Plastic Injection Moulds',
    'Zinc, Aluminum, and Magnesium Die-Casting Moulds',
    'Hot-Pressing and Heavy Hot Forging Dies',
    'Metal Extrusion Dies and Die Sets',
    'Moulds Requiring Chrome Surface Treatments',
    'Large Pre-Hardened Tooling Blocks',
    'High-Polish and Photo-Etched Mould Cavities'
  ]
