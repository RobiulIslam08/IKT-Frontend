...
import image from "../../../../assets/images/PlasticMouldSteel/Steel1.2083/image2.png"

export default function Applications() {
  const applications = [
    'Acidic Plastic Moulds (PVC Processing)',
    'High-Polish Optical Components (Cameras, Lenses)',
    'Medical Grade Containers and Equipment Moulds',
    'Long-Life Disposable Tableware Moulds',
    'Electric Erosion Operations (EDM)',
    'Hot Hard Type Plastic Moulding',
    'Corrosion-Resistant Plastic Injection Cavities'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="1.2083 Medical and Optical Moulds"
