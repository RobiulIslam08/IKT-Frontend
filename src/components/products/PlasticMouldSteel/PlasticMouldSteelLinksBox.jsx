...
const plasticMouldSteelLinks = [
	{ label: 'P20', href: '/products/p20' },
	{ label: 'OT718', href: '/products/ot718' },
	{ label: '1.2312', href: '/products/1-2312' },
	{ label: '1.2311', href: '/products/1-2311' },
	{ label: '1.2083', href: '/products/1-2083' },
];

const PlasticMouldSteelLinksBox = () => {
	...
	return (
		<section className="px-4 sm:px-6 lg:px-8 py-10 bg-slate-50">
			<div className="max-w-7xl mx-auto border border-slate-200 rounded-2xl p-6 md:p-8 bg-white shadow-sm text-center">
				<div className="mb-5">
					<h2 className="text-2xl md:text-3xl font-bold text-slate-900">Plastic Mould Steel</h2>
					<p className="text-sm md:text-base text-slate-600 mt-2">
						Browse all Plastic Mould Steel grades and related pages from one place.
					</p>
				</div>

				<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 justify-items-center">
					{plasticMouldSteelLinks.map((item) => {
...
export default PlasticMouldSteelLinksBox;
