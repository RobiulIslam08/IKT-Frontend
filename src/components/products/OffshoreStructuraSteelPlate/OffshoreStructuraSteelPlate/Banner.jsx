...
export default function Banner() {
	...
	const slides = [
		{
			title: 'OFFSHORE & STRUCTURA STEEL PLATE',
			description:
				'S355 is a high-strength, low-alloy (HSLA) structural steel designed to provide the backbone for modern infrastructure and offshore construction. IKT is a leading technical supplier of S355 plates, maintaining a comprehensive inventory of grades and thicknesses to satisfy the most stringent global engineering requirements.',
			points: [
