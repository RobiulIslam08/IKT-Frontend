...
export default function Applications() {
  ...
  "Energy & Oilfield Fabrications",
  "Heavy-Duty Plate Girders",
  "Marine Seafastenings & Supports",
  "Industrial Storage Solutions",
  "Renewable Offshore Foundations",
  "Semi-Submersible Platforms",
  "Offshore Jackets & Piling",
  "Deep-Sea Substructures",
  "Mooring & Calm Buoys",
  "Complex Stadia & Bridge Nodes"
	]
