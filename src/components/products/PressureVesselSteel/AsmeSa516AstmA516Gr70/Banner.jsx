...
export default function Banner() {
	...
	const slides = [
		{
			title: 'ASME SA516 / ASTM A516   Gr. 70',
			description:
				'In full compliance with ASME SA20/ASTM A20 standards, Grade 70 steel is recognized for its exceptional strength, superior weldability, and reliable performance under high pressure. IKT maintains an extensive inventory of SA516/A516 Gr. 70 plates, providing precision-processed solutions with global delivery capabilities to meet the most demanding boiler and pressure vessel applications.',
			points: [
