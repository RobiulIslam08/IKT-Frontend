...
export default function Banner() {
	...
	const slides = [
		{
			title: 'EN 10028:3 P355NL1 and P355NL2',
			description:
				'IKT carries an extensive inventory of pressure vessel plates certified to both EN 10028:3 P355NL1 and P355NL2 standards. These grades are widely recognized and specified for high-performance pressure vessel manufacturing across Europe, ensuring compliance with strict regional engineering requirements.',
			points: [
