...
export default function Banner() {
	...
	const slides = [
		{
			title: 'ASME SA516 / ASTM A516   Gr. 65',
			description:
				'Plates to this specification held in stock at our stockholding and processing facilities in Stoke-on-Trent in the UK. Fully accredited quality systems to ISO 9001, 14001 and 45001. Delivered worldwide by our international logistics organisation.',
			points: [
