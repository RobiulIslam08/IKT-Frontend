...
export default function Applications() {
  const applications = [
    'Gas Turbine Engineering and High-Stress Turbine Blades',
    'Aviation Engine Exhaust Reheaters and Afterburners',
    'Industrial Hot-Working Tools and High-Temperature Dies',
    'Precision High-Temperature Springs for Thermal Valves',
    'Nuclear Power Generation Thermal Structural Links',
    'Petrochemical Heating Retorts and Boiler Supports',
    'High-Performance Motorsport Engine Valves'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img
              src={image}
              alt="Nimonic Alloy 90 Applications"
