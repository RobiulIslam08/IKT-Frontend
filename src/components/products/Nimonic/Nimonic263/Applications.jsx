...
export default function Applications() {
  const applications = [
    'Aviation Gas Turbine Combustors and Engine Casings',
    'Exhaust Reheaters and Afterburner Assemblies',
    'Turbine Exhaust Cones and Low-Pressure Turbine Rings',
    'Industrial High-Temperature Pressure Vessels',
    'Specialized Combustion Hardware for Power Plants',
    'High-Stakes Petrochemical Heating Elements',
    'Nuclear Structural Thermal Components'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Nimonic C-263 Applications" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
