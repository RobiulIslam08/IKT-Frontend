...
export default function Banner() {
  const slides = [
    {
      title: 'IKT Nimonic C-263 (UNS N07263 / 2.4650)',
      description:
        'Nimonic C-263 is a precipitation-hardenable nickel-cobalt-chromium alloy designed for aerospace gas turbines. It offers excellent structural stability and high-temperature ductility, making it the premier choice for combustor components and engine casings in Saudi Arabia.',
      points: [
        'Superior high-temperature strength with excellent weldability in the annealed state.',
        'High resistance to oxidation and thermal fatigue up to 850°C.',
      ],
