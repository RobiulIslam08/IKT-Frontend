...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'UNS Designation', grade: 'N07263' },
    { standard: 'Germany (Werkstoff Nr.)', grade: '2.4650' },
    { standard: 'Alloy Type', grade: 'Nickel-Cobalt-Chromium Superalloy' },
    { standard: 'Trade Names', grade: 'Nimonic C-263, Alloy 263' }
  ];

  const chemicalData = [
    { element: 'Nickel (Ni)', content: 'Balance (Approx 49.0)' },
    { element: 'Cobalt (Co)', content: '19.0 - 21.0' },
    { element: 'Chromium (Cr)', content: '19.0 - 21.0' },
    { element: 'Molybdenum (Mo)', content: '5.60 - 6.10' },
    { element: 'Titanium (Ti)', content: '1.90 - 2.40' },
    { element: 'Aluminum (Al)', content: '≤ 0.60' },
    { element: 'Iron (Fe)', content: '≤ 0.70' },
    { element: 'Carbon (C)', content: '0.040 - 0.080' },
    { element: 'Boron (B)', content: '≤ 0.0050' },
    { element: 'Sulfur (S)', content: '≤ 0.0070' }
  ];

  const mechanicalData = [
    { property: 'Tensile Strength (Heat Treated RT)', value: '973 MPa Typical' },
    { property: 'Yield Strength (0.2% Offset)', value: '580 MPa Typical' },
    { property: 'Yield Strength (@ 780°C)', value: '403 MPa Min' },
    { property: 'Elongation at Break (RT)', value: '39 %' },
    { property: 'Hardness (Solution Treated)', value: '22.5 HV Max' }
  ];

  const physicalData = [
    { property: 'Density', value: '0.302 lb/in³' },
    { property: 'Melting Range', value: '2372 - 2471 °F' },
    { property: 'CTE (@ 400°F)', value: '6.7 x 10⁻⁶ in/in°F' },
    { property: 'CTE (@ 1800°F)', value: '10.2 x 10⁻⁶ in/in°F' }
  ];

  const supplyFormats = [
    { form: 'Seamless & Welded Pipe', specs: 'Turbine Combustor Grade' },
    { form: 'Nimonic 263 Tubing', specs: 'Precision High-Temp Instrumentation' },
    { form: 'Sheet & Plate', specs: 'AMS 5872 / BS HR206 Compliant' },
    { form: 'Welding Wire & Filler', specs: 'Nimonic Filler Metal 263' },
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 text-center">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT Nimonic C-263 (N07263) metallurgical matrix, mechanical performance, and global compliance benchmarks.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-12 p-8 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            Nimonic Alloy C-263 structural components, including combustor-grade plates, high-heat engine tubing, and precision welding wires, are heavily stocked across Saudi Arabia to empower rapid deployment in energy and aerospace sectors.
          </p>
