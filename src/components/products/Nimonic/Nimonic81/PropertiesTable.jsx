...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'International Grade', grade: 'Nimonic® Alloy 81' },
    { standard: 'Alloy Type', grade: 'Super Alloy (Nickel-Chromium)' },
    { standard: 'Trade Names', grade: 'Alloy 81, Nimonic 81' }
  ];

  const chemicalData = [
    { element: 'Nickel (Ni)', content: '63.0 Nominal' },
    { element: 'Chromium (Cr)', content: '≤ 30.0' },
    { element: 'Titanium (Ti)', content: '1.8' },
    { element: 'Cobalt (Co)', content: '≤ 2.0' },
    { element: 'Aluminum (Al)', content: '0.9' },
    { element: 'Iron (Fe)', content: '≤ 1.0' },
    { element: 'Others', content: 'Remainder' }
  ];

  const mechanicalData = [
    { property: 'Ultimate Tensile Strength', value: '874 MPa' },
    { property: '0.2% Yield Strength', value: '565 MPa' },
    { property: 'Elongation in 2"', value: '14.0 %' },
    { property: 'Physical Density', value: '8.06 g/cm³ (0.291 lb/in³)' }
  ];

  const thermalProcessing = [
    { process: 'Hot Working Range', value: '950 - 1160°C (1742 - 2120°F)' },
    { process: 'Hot Forging Temp', value: '1010 - 1176°C (1850 - 2150°F)' },
    { process: 'Solution Annealing', value: '1098°C (2010°F) for 8 Hours' },
    { process: 'Cold Working', value: 'Suitable for hardening' }
  ];

  const supplyFormats = [
    { form: 'Seamless & Welded Pipe', specs: 'Custom sizes for turbine eng.' },
    { form: 'Alloy 81 Tubing', specs: 'Heat Exchange Plant Grade' },
    { form: 'Sheet & Plate', specs: 'Exhaust Liner Thicknesses' },
    { form: 'Solid Round Bar', specs: 'Precision Valve Stem Forging' },
    { form: 'Forged Fittings', specs: 'High-Pressure Specs' }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 text-center">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT Nimonic 81 metallurgical matrix, structural performance, and processing benchmarks.</p>
        </motion.div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200 text-center">
                    ...
                    <th className="px-6 py-4 font-bold w-1/2">Operational Temperature</th>
                  </tr>
                </thead>
                <tbody>
                  {thermalProcessing.map((row, index) => (
                    <tr key={index} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors text-center">
        ...
        <motion.div variants={itemVariants} className="mt-12 p-8 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            Nimonic Alloy 81 structural components, including high-pressure engine tubing, exhaust liner plates, and precision forged valve bars, are heavily stocked across Saudi Arabia to empower rapid deployment in gas turbine and aerospace maintenance sectors.
          </p>
