...
export default function Applications() {
  const applications = [
    'Gas Turbine Engineering and Component Fabrication',
    'Piston Engine Exhaust Valves and Manifolds',
    'Industrial Heat Exchange Plants and Furnaces',
    'High-Temperature Nuclear Reactor Components',
    'Petrochemical Heating Retorts and Exhaust Liners',
    'Aerospace Transition Ducts and Afterburner Parts',
    'Cryogenic Application Structural Supports'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Nimonic Alloy 81 Industrial Applications"
