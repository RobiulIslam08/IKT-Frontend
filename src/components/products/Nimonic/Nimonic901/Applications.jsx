...
export default function Applications() {
  const applications = [
    'Aviation Gas Turbine Engine Discs and Rings',
    'High-Temperature Structural Aerospace Shafts',
    'Turbine Rotors and High-Stress Casings',
    'Advanced Piston Engine Valve Systems',
    'Industrial High-Pressure Components for Oil & Gas',
    'Hot-Working Tools and High-Stress Hardware',
    'Stationary Gas Turbine Structural Assemblies'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Nimonic Alloy 901 Applications" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
    </section>
