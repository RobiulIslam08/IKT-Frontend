...
export default function Applications() {
  const applications = [
    'Critical Gas Turbine Engine Blades and Components',
    'High-Temperature Structural Aerospace Forgings',
    'Advanced Piston Engine Exhaust Valves',
    'High-Stakes Industrial Heat Exchange Plants',
    'Specialized Thermal Hardware for Nuclear Engineering',
    'High-Stress Petrochemical Heating Retorts',
    'Extreme Environment Fasteners and Thermal Seals'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img
              src={image}
              alt="Nimonic Alloy 115 Applications"
