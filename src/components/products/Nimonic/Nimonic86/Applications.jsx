...
export default function Applications() {
  const applications = [
    'Gas Turbine Engine Combustion Chambers and Liners',
    'High-Temperature Industrial Furnaces and Heat-Treatment Equipment',
    'Petrochemical Heating Retorts and Exhaust Manifolds',
    'Aerospace Transition Ducts and Thermal Shielding',
    'Nuclear Power Generation Thermal Structural Components',
    'High-Stakes Chemical Processing Vessels',
    'Specialized Thermal Instrumentation and Sensor Housings'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img
              src={image}
              alt="Nimonic Alloy 86 Applications"
