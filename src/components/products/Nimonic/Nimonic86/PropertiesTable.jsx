...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'International Grade', grade: 'Nimonic® Alloy 86' },
    { standard: 'Trade Names', grade: 'Nimonic 86, Nimonic Alloy 86' },
    { standard: 'Alloy Type', grade: 'Nickel-Chromium-Molybdenum' }
  ];

  const chemicalData = [
    { element: 'Nickel (Ni)', content: '65.0 Nominal' },
    { element: 'Chromium (Cr)', content: '25.0' },
    { element: 'Molybdenum (Mo)', content: '10.0' },
    { element: 'Carbon (C)', content: '0.050' },
    { element: 'Cerium (Ce)', content: '0.030' }
  ];

  const mechanicalData = [
    { property: 'Tensile Strength (Solution Annealed)', value: '825 MPa (120,000 psi)' },
    { property: 'Yield Strength (0.2% Offset)', value: '410 MPa (59,500 psi)' },
    { property: 'Elongation at Break', value: '42.0 %' },
    { property: 'Elastic Modulus', value: '210 GPa (30,500 ksi)' }
  ];

  const physicalData = [
    { property: 'Density', value: '8.54 g/cm³ (0.309 lb/in³)' },
    { property: 'Melting Point', value: '1357 °C (2475 °F)' },
    { property: 'Thermal Expansion (20-100°C)', value: '12.7 µm/m°C' },
    { property: 'High Temp Oxidation Resistance', value: 'Excellent' }
  ];

  const supplyFormats = [
    { form: 'Seamless & Welded Pipe', specs: 'High-Temperature Gas Turbine Grade' },
    { form: 'Alloy 86 Tubing', specs: 'Heat-Treatment Plant Standard' },
    { form: 'Sheet & Plate', specs: 'Combustion Chamber Thicknesses' },
    { form: 'Solid Round Bar', specs: 'Precision Forged & Machined' },
    { form: 'Forged Fittings', specs: 'Bespoke Aerospace Hardware' }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 text-center">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT Nimonic 86 (N06086) chemical matrix, mechanical performance, and compliance benchmarks.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-12 p-8 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            Nimonic Alloy 86 structural components, including aerospace-certified turbine plates, high-heat tubing, and forged furnace bars, are heavily stocked across Saudi Arabia to empower rapid deployment in energy and petrochemical heating sectors.
          </p>
