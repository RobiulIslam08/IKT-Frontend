...
export default function Applications() {
  const applications = [
    'Gas Turbine Engine Components and Turbine Blades',
    'High-Temperature Turbine Discs and Rings',
    'Industrial Furnace Parts and Thermal Shielding',
    'Petrochemical Heating Retorts and Manifolds',
    'Aviation Engine Exhaust Reheaters',
    'Nuclear Power Thermal Structural Hardware',
    'Hot-Working Tools and High-Stress Dies'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img
              src={image}
              alt="Nimonic Alloy 105 Applications"
