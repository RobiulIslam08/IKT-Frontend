...
export default function Applications() {
  const applications = [
    'Gas Turbine Engineering and Aerospace Transition Liners',
    'Industrial Furnace Components and Muffle Linings',
    'Heat-Treatment Equipment and Specialized Tooling',
    'High-Temperature Nuclear Engineering Structures',
    'Petrochemical Heating Retorts and Exhaust Systems',
    'Internal Combustion Engine Valve Components',
    'High-Performance Industrial Hardware and Fasteners'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Nimonic Alloy 75 Applications"
