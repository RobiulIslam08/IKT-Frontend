...
export default function Applications() {
  const applications = [
    ...
    'Nuclear Steam Generator Piping and Fixtures',
    'Exhaust Valves in High-Performance Racing Engines',
    'Die-Casting Inserts, Cores, and Specialized Tooling',
    'High-Temperature Industrial Fasteners and Spindles',
    'Aerospace Engine Parts and Hot Mountings',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img
              src={image}
              alt="Nimonic Alloy 80A Industrial Applications"
