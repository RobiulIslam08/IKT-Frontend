...
export default function PropertiesTable() {
  ...
  const chemicalData = [
    { element: 'Carbon (C)', content: '0.85 - 0.95' },
    { element: 'Manganese (Mn)', content: '1.40 - 1.80' },
    { element: 'Chromium (Cr)', content: '≤ 0.50' },
    { element: 'Molybdenum (Mo)', content: '≤ 0.30' },
  ...
  const mechanicalData = [
    ...
    { property: 'Elastic Modulus (@ 25°C)', value: '27,557 - 30,458 ksi' },
    { property: 'Poisson’s Ratio', value: '0.27 - 0.30' },
    { property: 'Thermal Expansion (20-100°C)', value: '11.2 x 10⁻⁶/ºC' }
  ];
  ...
  const temperingData = [
    ...
    { property: 'Hardness (Tempered @ 300°C)', value: '56 - 55 HRC' },
    { property: 'Hardness (Tempered @ 400°C)', value: '50 - 49 HRC' }
  ];

  const physicalData = [
    { property: 'Annealing Temperature', value: '720 - 760 °C (Furnace cool slowly)' },
    { property: 'Pre-heating (Hardening)', value: '300 - 500 °C (If needed)' },
    { property: 'Hardening (Austenitizing)', value: '790 - 820 °C (Oil Quench)' },
    { property: 'Tempering Range', value: '100 - 400 °C' }
  ];
  ...
  const processingSteps = [
    { process: "High-Carbon Precision", details: "AISI O2 is a premium quality cold work tool steel. It belongs to the high-carbon alloy tool steel category, known for its deep hardening properties, excellent machinability, and edge retention." },
    ...
    { process: "Industrial Components", details: "Highly preferred for precision measuring tools, drawing punches, broaches, lathe centers, paper/cloth cutting machine knives, thread gauges, plastic moulds, and woodworking knives." }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT AISI O2 Cold Work Tool Steel chemistry, thermal processing metrics, and material supply standards.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            AISI O2 Cold Work Tool Steel components, including precision ground round bars, robust plates, and customized gauge plates, are heavily stocked across Saudi Arabia to support rapid blanking die and intricate press tooling deployment.
          </p>
