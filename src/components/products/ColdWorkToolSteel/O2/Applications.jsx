...
import image from "../../../../assets/images/ColdWorkToolSteel/O2/Gemini_Generated_Image_snv8hgsnv8hgsnv8.png"

export default function Applications() {
  const applications = [
    'Intricate Press Tools and Medium Run Dies',
    'Drawing Punches, Broaches, and Bushings',
    'Lathe Centers and Chuck Jaws',
    'Precision Plug and Thread Gauges',
    'Cutting Knives for Paper, Wood, and Cloth',
    'Master Cavity Sinking Hobs and Collets',
    'Cold Taps, Reamers, and Plastic Moulds'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="O2 Tool Steel Intricate Dies"
