...
export default function Applications() {
  const applications = [
    'High-Precision Metal Stamping and Blanking Dies',
    'Transformer Core Stamping Dies',
    'Thread Rolling and Deep Drawing Molding Dies',
    'Circular Saw Blades and Industrial Scissors',
    'Wear-Resistant Slider Cold Heading Dies',
    'Cold Extrusion and Dressing Dies',
    'Thermosetting Resin and Plastic Moulds'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="SKD11 Precision Stamping Dies"
