...
import image from "../../../../assets/images/ColdWorkToolSteel/A6/Gemini_Generated_Image_o1k5qo1k5qo1k5qo.png"

export default function Applications() {
  const applications = [
    'Industrial Slitters and Complex Die Shapes',
    'Heavy-Duty Cold Forging and Coining Dies',
    'Precision Cold Heading Dies',
    'High-Endurance Industrial Shear Blades',
    'Specialized Knurling Tools',
    'Cutting Knives for Paper and Wood',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="A6 Cold Work Blanking Dies"
