...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'USA (ASTM)', grade: 'ASTM A69 / A69M' },
    { standard: 'Europe (DIN EN)', grade: '10083/3' },
    { standard: 'Japan (JIS)', grade: 'G4053' },
    { standard: 'China (GB)', grade: 'GB/T 3077' }
  ];

  const chemicalData = [
    { element: 'Carbon (C)', content: '0.65 - 0.75' },
    { element: 'Manganese (Mn)', content: '1.80 - 2.50' },
    { element: 'Chromium (Cr)', content: '0.90 - 1.20' },
    { element: 'Molybdenum (Mo)', content: '0.90 - 1.40' },
    { element: 'Silicon (Si)', content: '0.20 - 0.50' },
  ...
  const temperingData = [
    { property: 'Hardness (Tempered @ 95°C)', value: '62 - 61 HRC' },
    { property: 'Hardness (Tempered @ 150°C)', value: '61 - 60 HRC' },
    { property: 'Hardness (Tempered @ 260°C)', value: '57 - 56 HRC' },
    { property: 'Hardness (Tempered @ 315°C)', value: '56 - 55 HRC' },
    { property: 'Hardness (Tempered @ 480°C)', value: '51 - 50 HRC' },
    { property: 'Hardness (Tempered @ 540°C)', value: '49 - 48 HRC' }
  ];
  ...
  const physicalData = [
    ...
    { property: 'Tempering Range', value: '95 - 540 °C' }
  ];
  ...
  const processingSteps = [
    { process: "High-Quality Cold Work Steel", details: "AISI A6 is a premium high-carbon, cold-work alloy tool steel. It requires light initial hammer blows and slow cooling after forging to prevent any possibility of cracking." },
    ...
    { process: "Industrial Cutting", details: "Due to its exceptional wear resistance and dimensional stability, it is widely preferred as a material for cutting knives used on paper, wood, fibre, and resin-bonded materials." }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT AISI A6 Cold Work Tool Steel chemistry, thermal processing metrics, and material supply standards.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            AISI A6 Cold Work Tool Steel components, including precision ground round bars, high-grade plates, and customized gauge plates, are heavily stocked across Saudi Arabia to support rapid tooling and industrial die deployment.
          </p>
