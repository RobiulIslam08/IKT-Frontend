...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'USA (ASTM)', grade: 'ASTM A681' },
    { standard: 'Europe (DIN EN)', grade: '10083/3' },
    { standard: 'Japan (JIS)', grade: 'G4053' },
    { standard: 'China (GB)', grade: 'GB/T 1299' }
  ];

  const chemicalData = [
    { element: 'Carbon (C)', content: '0.95 - 1.05' },
    { element: 'Manganese (Mn)', content: '1.80 - 2.20' },
    { element: 'Chromium (Cr)', content: '0.90 - 1.20' },
  ...
  const processingSteps = [
    { process: "High-Manganese Alloy", details: "AISI A4 is a premium quality cold work tool steel. It is a high-carbon, high-manganese, chrome, and molybdenum alloy requiring light initial hammer blows and slow cooling after forging to prevent cracking." },
    ...
    { process: "Industrial Cutting", details: "Due to its exceptional wear resistance, hardness retention, and toughness, it is widely preferred as a material for cutting knives used on paper, wood, fibre, and resin-bonded materials." }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT AISI A4 Cold Work Tool Steel chemistry, thermal processing metrics, and material supply standards.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            AISI A4 Cold Work Tool Steel components, including precision ground round bars, high-grade plates, and customized gauge plates, are heavily stocked across Saudi Arabia to support rapid tooling and industrial die deployment.
          </p>
