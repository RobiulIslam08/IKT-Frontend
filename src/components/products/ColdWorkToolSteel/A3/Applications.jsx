...
import image from "../../../../assets/images/ColdWorkToolSteel/A3/Gemini_Generated_Image_mhvnvkmhvnvkmhvn.png"

export default function Applications() {
  const applications = [
    'Industrial Slitters and Complex Die Shapes',
    'Heavy-Duty Cold Forging Dies',
    'Precision Coining and Cold Heading Dies',
    'High-Endurance Industrial Shear Blades',
    'Specialized Knurling Tools',
    'Cutting Knives for Paper and Wood Industries',
    'Blades for Fibre and Resin-Bonded Materials'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="A3 Tool Steel Cold Forging Dies"
