...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'USA (ASTM / UNS)', grade: 'ASTM A681 / UNS T30103' },
    { standard: 'Federal Standard', grade: 'FED QQ-T-570' },
  ...
  const processingSteps = [
    { process: "High-Carbon Alloy", details: "AISI A3 is a premium quality cold work tool steel. It belongs to the high carbon, high alloy tool steel family, requiring very slow cooling after forging to avoid the possibility of cracking." },
    { process: "Tooling & Die Applications", details: "Extensively utilized for heavy-duty industrial tooling including slitters, die shapes, cold forging dies, coining dies, cold heading dies, shear blades, and knurling tools." },
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT AISI A3 Cold Work Tool Steel chemistry, thermal processing metrics, and material supply standards.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            AISI A3 Cold Work Tool Steel components, including precision ground round bars, high-grade plates, and customized gauge plates, are heavily stocked across Saudi Arabia to support rapid tooling and industrial die deployment.
          </p>
