...
import image from "../../../../assets/images/ColdWorkToolSteel/DC53/Gemini_Generated_Image_wdw0vwwdw0vwwdw0.png"

export default function Applications() {
  const applications = [
    'Heavy-Duty Punches and Cold Form Dies',
    'High-Precision Draw and Forming Dies',
    'Industrial Shear Blades and Slitters',
    'High-Impact Shredder Knives',
    'Thread and Form Rolling Tools',
    'Advanced Cold Heading Dies',
    'Machine Mill Rolls and Rotary Cutters'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="DC53 Tool Steel Punches and Dies"
