...
import image from "../../../../assets/images/ColdWorkToolSteel/A8/Gemini_Generated_Image_3hqh9i3hqh9i3hqh.png"

export default function Applications() {
  const applications = [
    'Heavy-Duty Punches and Drift Pins',
    'High-Impact Pneumatic Tools',
    'Industrial Chuck Jaws and Hammers',
    'Hot Rolls and Forming Equipment',
    'Hot and Cold Shear Knives',
    'Precision Slitters and Cutting Tools',
    'Complex Die Shapes and Molds'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="A8 Tool Steel Punches and Knives"
