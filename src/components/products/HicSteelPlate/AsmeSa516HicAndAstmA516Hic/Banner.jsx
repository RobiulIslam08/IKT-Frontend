...
export default function Banner() {
	...
	const slides = [
		{
			title: 'ASME SA516 HIC AND ASTM A516 HIC',
			description:
				'To support rapid project timelines, we offer a comprehensive stock range with immediate availability:',
			points: [
				'Thickness Range: In-stock plates ranging from 6 mm up to 180 mm.',
				'Ready for Dispatch: Our inventory is strategically managed to ensure quick delivery for both small-scale fabrications and large-scale industrial projects.',
