...
export default function Applications() {
	const applications = [
	'Critical Oilfield Fabrications',
    'Industrial Boilers & Calorifiers',
    'Precision Dished Ends',
    'Specialized Piping Flanges',
    'High-Performance Heat Exchangers',
    'Sour-Service Pipelines',
    'High-Pressure Vessels',
    'LPG & Chemical Storage Tanks',
    'Valves, Flanges & Critical Fittings',
    'High-Efficiency Condensers',
    'Specialized Pipe Caps & Fittings'
	]
