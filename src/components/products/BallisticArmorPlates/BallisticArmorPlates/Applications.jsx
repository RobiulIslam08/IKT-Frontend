...
export default function Applications() {
	const applications = [
		'Armoured Military & Tactical Vehicles',
		'Cash-in-Transit (CIT) & VIP Vehicles',
		'Ballistic Protection for Critical Infrastructure',
		'Security Doors, Guard Booths & Safe Rooms',
		'Naval & Maritime Defense Platforms',
		'Personnel Body Armor Inserts',
		'Helicopter & Aircraft Floor Protection',
	]
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					>
						<div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
							<img
								src={image}
								alt="Ballistic Armor Plates Application"
