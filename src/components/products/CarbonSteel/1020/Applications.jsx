...
export default function Applications() {
  const applications = [
    'Automotive and Tractor Machinery Parts',
    'Carburized and Carbonitrided Gears and Camshafts',
    'Heavy Machinery Rods, Shackles, and Sleeves',
    'Boiler Pipes and Flanges (Operating ≤ 450°C)',
    'Locomotive Crossheads and Piston Castings',
    'Cold Extrusion and General Structural Fasteners',
    'Car Hand Brake Shoes and Fork Lever Shafts'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="1020 Mild Steel Machinery Parts"
