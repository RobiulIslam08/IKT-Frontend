...
//     { standard: 'European (DIN EN 10025-1998)', grade: 'S235JR' },
//     { standard: 'Chinese (GB)', grade: 'Q235B' }
//   ];

//   // Chemical Composition
//   const chemicalData = [
//     { c: '≤ 0.20', mn: '≤ 1.40', p: '≤ 0.045', s: '≤ 0.45', n: '≤ 0.009' }
//   ];
...
//           </div>
//           <p className="text-base font-medium text-gray-600 ml-7">IKT S235JR mild structural steel chemistry, standard equivalents, and KSA tolerances.</p>
//         </motion.div>
...
//                <h3 className="text-lg font-bold text-gray-800">Standard Equivalents</h3>
//             </div>
...
//                     <th className="px-4 py-4 text-center font-bold">N%</th>
//                   </tr>
//                 </thead>
//                 <tbody>
...
//                       <td className="px-4 py-4 text-center text-gray-700 font-medium">{row.n}</td>
//                     </tr>
//                   ))}
//                 </tbody>
//               </table>
...
//               <span className="font-bold text-gray-900">IKT Structural Customization in KSA:</span> 
//               S235JR mild steel round bars and flat sections can be cut precisely to your structural specifications. Ground tool steel bars and precision Gauge Plates are also available in custom sizes.
//             </p>
//             <p className="text-sm font-medium text-gray-600">For unlisted sizes or specific engineering inquiries, contact our expert team in Saudi Arabia at <span className="font-bold">+966-13-3444036</span>.</p>
//           </div>
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base text-gray-600">IKT S235JR mild structural steel chemistry, standard equivalents, and KSA tolerances for industrial applications.</p>
        </motion.div>
          ...
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            <div className="bg-white px-6 py-6 text-center">
              <h3 className="text-2xl font-bold text-gray-900 flex items-center justify-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary"></span> Standard Equivalents
              </h3>
            </div>
            <div className="overflow-x-auto">
                ...
                <tbody>
                  {chemicalData.map((row, index) => (
                    <tr key={index} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-4 text-center text-gray-700 font-medium text-base">{row.n}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Structural Customization in KSA:</span> 
            S235JR mild steel round bars and flat sections can be cut precisely to your structural specifications. Ground tool steel bars and precision Gauge Plates are also available in custom sizes across Saudi Arabia.
          </p>
          <p className="text-base font-medium text-gray-600">
            For structural sizing details, unlisted dimensions, or engineering inquiries, please contact our expert team in Saudi Arabia at <span className="font-bold text-primary">+966-13-3444036</span> or email <span className="font-bold text-primary">sales@ikt.sa</span>.
          </p>
        </motion.div>
