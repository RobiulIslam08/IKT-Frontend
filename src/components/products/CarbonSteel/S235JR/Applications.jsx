...
import image from "../../../../assets/images/CarbonSteel/SteelS235JR/image2.png"

export default function Applications() {
  const applications = [
    'Heavy Structural Buildings and Bridges',
    'Marine Vessels and Ship Manufacturing',
    'Commercial and Industrial Vehicle Structures',
    'Advanced Welded and Riveted Assemblies',
    'High-Strength Bolted Structural Connections',
    'General Machinery Tools and Cutters',
    'Standard Moulds and Precision Measuring Tools'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="S235JR Structural Steel Construction"
