...
//     { standard: 'Chinese (GB/T 700-1988)', grade: 'Q235B' },
//     { standard: 'European (DIN EN)', grade: 'S235JR' }
//   ];

//   // Chemical Composition
//   const chemicalData = [
//     { c: '0.12 - 0.20', si: '≤ 0.30', mn: '0.30 - 0.70', p: '≤ 0.045', s: '≤ 0.45' }
//   ];
...
//           </div>
//           <p className="text-base font-medium text-gray-600 ml-7">IKT Q235B mild structural steel chemistry, equivalency, and KSA tolerances.</p>
//         </motion.div>
...
//               Q235B mild steel round bars and flat sections can be cut precisely to your structural specifications. We also supply precision grind tool steel and Gauge Plates in custom sizes.
//             </p>
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base text-gray-600">IKT Q235B mild structural steel chemistry, standard equivalents, and KSA tolerances for engineering.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            <span className="font-bold text-gray-900">IKT Structural Customization in KSA:</span> 
            Q235B mild steel round bars and flat sections can be cut precisely to your structural specifications. We also supply precision grind tool steel and Gauge Plates in custom sizes across Saudi Arabia.
          </p>
          <p className="text-base font-medium text-gray-600">
            For structural sizing details or specialized engineering inquiries, please contact our expert team in Saudi Arabia at <span className="font-bold text-primary">+966-13-3444036</span> or email <span className="font-bold text-primary">sales@ikt.sa</span>.
          </p>
        </motion.div>
