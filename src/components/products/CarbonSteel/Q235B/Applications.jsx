...
import image from "../../../../assets/images/CarbonSteel/SteelQ235B/image2.png"

export default function Applications() {
  const applications = [
    'Heavy Structural Frameworks for Buildings',
    'Bridge Construction and Engineering',
    'Marine Vessels and Ship Building',
    'Industrial Vehicle and Trailer Structures',
    'Advanced Welded and Riveted Assemblies',
    'General Machinery Tools and Basic Cutters',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Q235B Mild Steel Structural Frameworks"
