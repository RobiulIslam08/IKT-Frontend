...
import image from "../../../../assets/images/CarbonSteel/Steel1045/image2.png"

export default function Applications() {
  const applications = [
    'Heavy-Duty Axles and Drive Shafts',
    'High-Strength Bolts, Nuts, and Studs',
    'Industrial Connecting Rods and Spindles',
    'Hydraulic Clamps, Rams, and Cylinders',
    'Various Precision Machined Pins',
    'Industrial Manufacturing Rolls',
    'Medium Tensile Structural Components'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="1045 Carbon Steel Axles and Shafts"
