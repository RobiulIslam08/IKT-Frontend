...
export default function Banner() {
	...
	const slides = [
		{
			title: 'EN 10028:3 P275NH',
			description:
				'IKT maintains a robust inventory of boiler plate steel certified to EN 10028:3 P275NH. This specification defines a specialized range of weldable, fine-grain steels supplied in a normalized condition, specifically engineered for high-reliability pressure applications.',
			points: [
