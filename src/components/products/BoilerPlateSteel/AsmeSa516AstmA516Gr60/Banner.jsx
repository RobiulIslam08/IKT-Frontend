...
export default function Banner() {
	...
	const slides = [
		{
			title: 'ASME SA516 / ASTM A516 Gr. 60',
			description:
				'Leverage IKT’s extensive technical expertise in the supply and processing of ASME SA516 and ASTM A516 carbon steel plates. As trusted specialists, we provide tailored solutions for diverse industrial applications, ensuring every project meets the highest engineering standards.',
			points: [
