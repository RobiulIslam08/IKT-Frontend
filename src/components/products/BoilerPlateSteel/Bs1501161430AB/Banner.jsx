...
export default function Banner() {
	...
	const slides = [
		{
			title: 'BS 1501 161 430 A/B',
			description:
				'IKT maintains a consistent and significant inventory of boiler plates certified to BS 1501 161 430A and BS 1501 161 430B. Our strategic stock management ensures that these critical grades are always available for immediate supply, supporting your project’s continuity and timeline.',
			points: [
