...
export default function Banner() {
	...
	const slides = [
		{
			title: 'EN 10028:2 P265GH',
			description:
				'IKT maintains a specialized inventory of boiler plate steel certified to EN 10028:2 P265GH. This grade is recognized as the closest modern European equivalent to the withdrawn German DIN 17155 HII specification, making it a reliable choice for both legacy repairs and new high-performance fabrications.',
			points: [
