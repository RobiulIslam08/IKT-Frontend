...
export default function Applications() {
  const applications = [
    'Offshore Oil & Gas Seawater Cooling Systems',
    'Desalination Plant Distillation and Brine Piping',
    'Shipbuilding, Ship Repair, and Boat Hulls',
    'High-Velocity Condenser and Heat Exchanger Tubes',
    'Marine Antimicrobial Surfaces and Hardware',
    'Automotive Brake Tubing and Power Steering Lines',
    'Coinage and Pressure Vessel Components'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Cupro Nickel 70/30 Seawater Systems"
