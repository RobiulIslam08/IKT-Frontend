...
export default function PropertiesTable() {
  ...
  const equivalentsData = [
    { standard: 'UNS Designation', grade: 'C71500 / C71520' },
    { standard: 'Germany (Werkstoff Nr.)', grade: '2.0882' },
    { standard: 'Europe (EN)', grade: 'CW354H' },
    { standard: 'British (BS)', grade: 'CN107 / NES 780' }
  ];

  const chemicalData = [
    { element: 'Copper (Cu)', content: 'Balance (69.5 Nominal)' },
    { element: 'Nickel (Ni)', content: '29.0 - 33.0' },
    { element: 'Iron (Fe)', content: '0.40 - 1.0' },
  ...
  const mechanicalData = [
    { property: 'Ultimate Tensile Strength', value: '359 - 538 MPa (52 - 78 ksi)' },
    { property: 'Yield Strength (0.2% Offset)', value: '124 - 503 MPa (18 - 73 ksi)' },
    { property: 'Elongation at Break', value: '35.0 %' },
    { property: 'Modulus of Elasticity', value: '152 GPa (22,000 ksi)' },
    { property: 'Machinability Rating', value: '20 %' }
  ];

  const physicalData = [
    { property: 'Density', value: '8.94 g/cc (0.323 lb/in³)' },
    { property: 'Thermal Conductivity', value: '29.0 W/m-K (16.8 BTU/ft/h/°F)' },
    { property: 'Specific Heat Capacity', value: '0.377 J/g-°C (0.0900 BTU/lb-°F)' },
    { property: 'Linear CTE', value: '16.2 µm/m-°C (9.00 µin/in-°F)' }
  ];

  const fabricationSuitability = [
    { method: 'Soldering & Brazing', rating: 'Excellent' },
    { method: 'Gas Shielded Arc Welding', rating: 'Excellent' },
    { method: 'Coated Metal Arc Welding', rating: 'Excellent' },
    { method: 'Butt Welding', rating: 'Excellent' },
    { method: 'Spot & Seam Weld', rating: 'Excellent' },
    { method: 'Cold Worked & Hot Formed', rating: 'Good' },
    { method: 'Oxyacetylene Welding', rating: 'Good' }
  ];

  const supplyFormats = [
    { form: 'Seamless Pipe & Tube', specs: 'ASTM B111 / ASME SB111' },
    { form: 'Welded Pipe & Tube', specs: 'ASME SB467 / ASTM B608' },
    { form: 'Sheet, Plate & Strip', specs: 'ASTM B122 / SB171' },
    { form: 'Solid Rod, Bar & Wire', specs: 'ASTM B151 / MIL-C-15726' },
    { form: 'Condenser Plates', specs: 'SAE J463 / J461' }
  ];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 text-center">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-16 text-center">
          ...
          <p className="text-base font-medium text-gray-600">IKT Cupro Nickel 70/30 (C71500) chemical matrix, physical dynamics, and industrial compliance benchmarks.</p>
        </motion.div>
        ...
        <div className="flex flex-col gap-10">
          ...
          <motion.div variants={itemVariants} className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden w-full">
            <div className="bg-primary/10 px-6 py-4 border-b border-gray-200 text-center">
              <h3 className="text-xl font-bold text-gray-800">Fabrication Suitability Ratings</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200 text-center">
                    <th className="px-6 py-4 font-bold border-r border-gray-100 w-1/2">Technique / Process</th>
                    <th className="px-6 py-4 font-bold w-1/2">Suitability Status</th>
                  </tr>
                </thead>
                <tbody>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-base text-gray-900 border-b border-gray-200 text-center">
                    ...
                    <th className="px-6 py-4 font-bold w-1/2">ASME & ASTM Compliance</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <motion.div variants={itemVariants} className="mt-12 p-8 bg-gray-100 border border-gray-200 rounded-lg text-center md:text-left">
          <p className="text-base font-medium text-gray-700 mb-2">
            ...
            Cupro Nickel 70/30 structural components, including high-pressure condenser tubes, saltwater seamless pipes, and bespoke forged marine fittings, are heavily stocked across Saudi Arabia to empower rapid deployment in desalination and offshore petrochemical frameworks.
          </p>
