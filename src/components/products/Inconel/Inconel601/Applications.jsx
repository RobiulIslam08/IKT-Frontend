...
export default function Applications() {
  const applications = [
    'High-Temperature Heat Treating Muffles and Retorts',
    'Catalyst Support Grids in Nitric Acid Production',
    'Aerospace Components and Power Generation',
    'Radiant Tubes and Steam Superheater Supports',
    'Advanced Chemical Processing Equipment',
    'Thermal Cycling Industrial Environments',
    'Fabricated High-Strength Structural Fasteners'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Inconel 601 Industrial Components"
