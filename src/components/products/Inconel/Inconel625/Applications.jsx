...
export default function Applications() {
  const applications = [
    'Advanced Aerospace and Aircraft Ducting Systems',
    'Offshore Specialized Seawater Equipment',
    'Jet Engine Exhaust and Thrust-Reverser Systems',
    'Aggressive Chemical Processing Environments',
    'High-Temperature Recuperators and Compensators',
    'Offshore Platform Flaring and Exhaust Systems',
    'Thermal Fatigue Resistant LCF Bellows'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Inconel 625 Aerospace Components"
