...
export default function Applications() {
  const applications = [
    'High-Strength Industrial Fasteners and Bolts',
    'Advanced Aerospace and Aircraft Components',
    'Heavy-Duty Springs and Extrusion Tooling',
    'Nuclear Reactor Structural Assemblies',
    'High-Temperature Gas Turbine Engine Parts',
    'Deep Hole Drilling and Offshore Equipment',
    'Precision Pressure Vessels and Tubing'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Inconel X750 High Strength Fasteners"
