...
export default function Applications() {
  const applications = [
    'High-Speed Airframe Components and Jet Engines',
    'Liquid Fuel Rocket Motor Assemblies',
    'Deep Cryogenic Storage Tanks and Piping',
    'Nuclear Reactor Structural Components',
    'Advanced Blow Out Preventers (BOP) and Wellheads',
    'Heavy-Duty Fasteners, Springs, and Mandrels',
    'Industrial Gas Turbine Engine Parts'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Inconel 718 Aerospace Components"
