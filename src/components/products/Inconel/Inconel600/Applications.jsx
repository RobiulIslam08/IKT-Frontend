...
export default function Applications() {
  const applications = [
    ...
    'High-Temperature Heat Treating Furnaces',
    'Nuclear Engineering and Reactor Systems',
    'Pulp, Paper, and Food Processing Machinery',
    'High-Pressure Heat Exchangers and Piping',
    'Corrosion-Resistant Industrial Fasteners'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Inconel 600 Heat Treating Components"
