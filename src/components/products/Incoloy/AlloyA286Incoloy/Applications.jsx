...
export default function Applications() {
  const applications = [
    ...
    'Jet Engine Components and Turbine Wheels',
    'Offshore Oil & Gas Structural Equipment',
    'Automotive Exhaust Systems and Manifolds',
    'Industrial Superchargers and Cryogenic Tanks',
    'High-Strength Non-Magnetic Forgings',
    'Aviation Reactor and Burner Assemblies'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="A286 Stainless Steel Aerospace Fasteners"
