...
export default function Applications() {
  const applications = [
    'Industrial Heating and Thermal Systems',
    'High-Temperature Furnaces, Muffles, and Retorts',
    'Continuous Thermal Conveyor Belt Systems',
    'Heat Treating Baskets and Heavy Fixtures',
    'Petrochemical Carburizing Environments',
    'Nitridation-Resistant Processing Equipment',
    'High-Strength Boiler and Reactor Fasteners'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Alloy 330 High Temperature Furnaces"
