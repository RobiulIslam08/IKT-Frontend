...
export default function Applications() {
  const applications = [
    'High-Temperature Heat Exchangers and Piping',
    'Chemical and Petrochemical Processing Equipment',
    'Power Generation and Superheater Tubes',
    'Industrial Furnaces and Heat-Treating Equipment',
    'Hydrocarbon Cracking and Processing Plants',
    'Pressure Vessels and High-Heat Storage Tanks',
    'Heavy-Duty Fasteners and Structural Bolts'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Incoloy 800 Heat Treating Equipment"
