...
export default function Applications() {
  const applications = [
    'Down-Hole and Surface Gas Well Components',
    'High-Strength Fasteners for Sour Gas Environments',
    'Offshore Piping and Subsea Systems',
    'Heavy-Duty Valves, Hangers, and Tool Joints',
    'Advanced Chemical Processing Equipment',
    'High-Pressure Forging Stock and Shafts',
    'NACE MR-01-75 Compliant Structural Assemblies'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Incoloy 925 Offshore Gas Drilling Components"
