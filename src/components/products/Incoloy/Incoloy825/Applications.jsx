...
export default function Applications() {
  const applications = [
    'Offshore Oil and Gas Well Piping Systems',
    'Sulfuric and Phosphoric Acid Processing Facilities',
    'Nuclear Fuel Reprocessing and Waste Handling',
    'Seawater and Air-Cooled Heat Exchangers',
    'Marine Propeller Shafts and Deep Injection Piping',
    'Pickling Equipment (Heating Coils, Tanks, Hooks)',
    'Pollution Control and Sour Gas Components'
  ]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img
                src={image}
                alt="Incoloy 825 Offshore Chemical Equipment"
