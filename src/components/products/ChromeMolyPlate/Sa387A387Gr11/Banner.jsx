...
export default function Banner() {
	...
	const slides = [
		{
			title: 'SA387 / A387 Gr 11',
			description:
				'At IKT, we take pride in our extensive inventory of Chrome Moly pressure vessel plates, specifically engineered for high-temperature and high-pressure environments. Our stock features a diverse range of grades and thicknesses, ensuring that we can meet the rigorous demands of global industrial applications.',
			points: [
