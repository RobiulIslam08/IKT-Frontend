...
export default function Applications() {
  const applications = [
    ...
    'Industrial Warehouses and Factory Structures',
    'Airports, Stadiums, and Public Infrastructure',
    'Residential and Mixed-Use Developments',
    'Foundations, Piling, and Deep Excavation Works',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="relative group flex items-center justify-center">
            <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
              <img src={image} alt="Construction Steel Applications" className="w-full h-full object-cover object-center" />
            </div>
          </motion.div>
        </div>
      </div>
