...
import banner1 from "../../../assets/images/Sectors/constraction1.png";

export default function Banner() {
  const slides = [
    {
      title: 'IKT Structural Construction Steel Solutions',
      description:
      ...
      points: [
        'Full range of beams, columns, channels, and structural angles.',
        'Advanced surface treatments and just-in-time delivery for high-stakes sites.',
      ],
