...
import image from "../../../assets/images/Sectors/agriculture.png";

export default function Applications() {
  const applications = [
    'Livestock Enclosures and Internal Barn Fencing Systems',
    'Animal Flooring for Pigs and Sheep (Flattened & Raised Mesh)',
    'Grain Drying and Seed Storage Safety Applications (TCG Mesh)',
    'Machinery Protection and Building Safeguarding (Armco Barriers)',
    'Hands-Free Self-Closing Safety Gates for Farm Access',
    'External Perimeter Fencing and Cattle Control Structures',
    'Industrial Farming Walkways and Handrail Systems'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="mb-8">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-[#1a3a4a]">Agriculture Sector Applications</h2>
              </div>
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Agricultural Steel Materials" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
