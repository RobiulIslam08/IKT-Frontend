...
export default function PropertiesTable() {
  const keyMaterials = [{"material":"Galvanized Structural Steel","standard":"EN 10346 / ASTM A653 G90"},{"material":"Wear-Resistant Steel","standard":"Hardox 400 / Quard 500"},{"material":"Hot-Rolled Structural Sections","standard":"EN 10025 S235 / S275 JR"},{"material":"Steel Pipe for Irrigation","standard":"ASTM A53 / EN 10217 Class 1"},{"material":"Pre-Galvanized Sheet Steel","standard":"DX51D+Z100 / EN 10347"}];
  const sectorApplications = [{"process":"Farm Machinery","details":"Abrasion-resistant and high-strength steel for plough blades, disc harrows, cultivation equipment, and harvesting machinery frames and components."},{"process":"Irrigation Systems","details":"Galvanized steel pipes and structural sections for pivot irrigation systems, water distribution networks, and underground irrigation infrastructure."},{"process":"Storage Infrastructure","details":"Structural steel frames, purlins, and cladding materials for agricultural storage buildings, grain silos, and produce warehousing facilities."}];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base font-medium text-gray-600">Certified agricultural sector steel materials, specifications, and supply formats available in KSA.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center">
          <p className="text-base font-medium text-gray-700 mb-2"><span className="font-bold text-gray-900">IKT Agricultural Steel Supply in KSA:</span> Full range of certified materials stocked across Saudi Arabia for immediate sector deployment and rapid project support.</p>
