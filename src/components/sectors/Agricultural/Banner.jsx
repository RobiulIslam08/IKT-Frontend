...
export default function Banner() {
  const slide = {
    title: 'IKT Steel for Agricultural Sector',
    description: 'IKT provides high-quality structural steel, specialty coated steel, and abrasion-resistant materials for agricultural machinery, irrigation infrastructure, and farm storage systems across Saudi Arabia and the broader MENA agricultural sector.',
    points: [
      'Galvanized and coated steels for corrosion-resistant agricultural infrastructure.',
      'High-strength wear-resistant steel for agricultural machinery, tillers, and ground-engaging tools.',
    ],
