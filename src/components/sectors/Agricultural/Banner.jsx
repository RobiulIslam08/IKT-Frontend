...
import banner1 from "../../../assets/images/Sectors/agriculture2.png";

export default function Banner() {
  const slides = [
    {
      title: 'IKT Specialized Agricultural Steel Solutions',
      description:
      ...
      points: [
        'Complete stock range for barn fencing, grain storage, and safety barriers.',
        'Cost-effective and robust solutions for livestock management and protection.',
      ],
