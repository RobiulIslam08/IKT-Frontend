...
export default function Banner() {
  const slide = {
    title: 'IKT Steel for Transport Sector',
    description: 'IKT is a trusted supplier of certified structural steel, high-strength alloys, and specialty materials for transport infrastructure and vehicle manufacturing in Saudi Arabia. Our materials support roads, railways, ports, airports, and commercial vehicle production.',
    points: [
      'High-strength structural steel for bridges, flyovers, and transport infrastructure projects.',
      'Certified railway and shipbuilding-grade steel for public transport and maritime sectors.',
    ],
