...
import banner1 from "../../../assets/images/Sectors/transport.png";

export default function Banner() {
  const slides = [
    {
      title: 'IKT Precision Steel for the Transport Industry',
      description:
      ...
      points: [
        'Advanced 3D modeling for highly complex shapes and designs.',
        'Precision-processed parts ready for immediate assembly line use.',
      ],
