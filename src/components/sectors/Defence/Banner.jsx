...
import banner1 from "../../../assets/images/Sectors/defence.png";

export default function Banner() {
  const slides = [
    {
      title: 'IKT High-Assurance Steel for Defence & Security',
      description:
      ...
      points: [
        'Approved supplier for high-stakes UK and NATO defence frameworks.',
        'Domestic KSA inventory to mitigate geopolitical supply chain risks.',
      ],
