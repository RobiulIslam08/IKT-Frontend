...
export default function Banner() {
  const slide = {
    title: 'IKT Steel Solutions for Defence',
    description: 'IKT supplies mission-critical steel and advanced alloys engineered for defence applications. Our materials meet the most stringent military specifications for armour, vehicles, weapons systems, and protective infrastructure across Saudi Arabia.',
    points: [
      'Ballistic-grade armour steel and STANAG-certified materials for military protection.',
      'High-strength structural steel for defence facilities, bunkers, and vehicle components.',
    ],
