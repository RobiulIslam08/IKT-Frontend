...
import image from "../../../assets/images/SpeacialAlloys/common1.png"

export default function Applications() {
  const applications = [
    'Armoured Ground Vehicle Fleets and Chassis Fabrication',
    'Safety-Critical Roll-Over (ROPS) & Falling Object (FOPS) Structures',
    'Military Bridging Systems and Modular Rapid-Deployment Units',
    'Tactical Defence Infrastructure and High-Assurance Hardware',
    'Lightweight Vehicle Frames using S700 High-Tensile Steel',
    'Combat Aircraft Support Frameworks and Ground Equipment',
    'Strategic Energy and National Security Infrastructure Projects'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="mb-8">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-[#1a3a4a]">Defence Industry Applications</h2>
              </div>
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Defence Sector Steel Usage" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
