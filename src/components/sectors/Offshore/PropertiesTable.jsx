...
export default function PropertiesTable() {
  const keyMaterials = [{"material":"Offshore Structural Steel","standard":"EN 10225 S355G7+M / S420G1"},{"material":"Duplex Stainless Steel","standard":"ASTM A790 UNS S31803"},{"material":"Super Duplex Stainless","standard":"ASTM A790 UNS S32750/S32760"},{"material":"Marine Steel Plate","standard":"AH36, DH36, EH36 Grade Steel"},{"material":"Subsea Alloy Pipe","standard":"ASTM A312 / 625 Clad Linepipe"}];
  const sectorApplications = [{"process":"Platform Structures","details":"Marine-class structural steel for offshore platform jackets, topsides, helidecks, and walkways in offshore Arabian Gulf operations."},{"process":"Subsea Systems","details":"Duplex and super duplex steel components for subsea Christmas trees, manifolds, and flowline systems in deepwater environments."},{"process":"Marine Vessels","details":"Shipbuilding grades AH36/DH36 and high-strength marine alloys for offshore support vessels, crane barges, and pipelay vessels."}];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base font-medium text-gray-600">Certified offshore sector steel materials, specifications, and supply formats available in KSA.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center">
          <p className="text-base font-medium text-gray-700 mb-2"><span className="font-bold text-gray-900">IKT Offshore Steel Supply in KSA:</span> Full range of certified materials stocked across Saudi Arabia for immediate sector deployment and rapid project support.</p>
