...
import banner1 from "../../../assets/images/Sectors/Offshore.png";

export default function Banner() {
  const slides = [
    {
      title: 'IKT Offshore & Renewable Energy Solutions',
      description:
      ...
      points: [
        'Premium EN 10025 & EN 10210 certified offshore structural steel.',
        'Unrivalled processing with jumbo tube lasers for long-length marine frames.',
      ],
