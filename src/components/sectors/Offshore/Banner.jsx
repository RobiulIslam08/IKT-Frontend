...
export default function Banner() {
  const slide = {
    title: 'IKT Steel for Offshore Industry',
    description: 'IKT supplies certified offshore-grade structural steel, subsea materials, and corrosion-resistant alloys for offshore oil platforms, marine structures, and subsea installations. Our materials meet DNV, ABS, Lloyds, and BV marine class certifications.',
    points: [
      'Marine-class structural steel certified by DNV-GL, ABS, or Bureau Veritas for offshore platforms.',
      'Subsea-grade corrosion-resistant alloys for pipeline, riser, and umbilical applications.',
    ],
