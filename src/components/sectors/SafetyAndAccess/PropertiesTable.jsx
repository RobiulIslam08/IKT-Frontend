...
export default function PropertiesTable() {
  const keyMaterials = [{"material":"Steel Floor Grating","standard":"EN ISO 14122 / ASTM A569"},{"material":"Chequered Plate","standard":"EN 10025 S235JR Anti-Slip"},{"material":"Hollow Sections for Handrail","standard":"EN 10210 / ASTM A500 CHS/RHS"},{"material":"Barrier Beam Steel","standard":"EN 1317 / AASHTO M-180"},{"material":"Scaffold Tube Steel","standard":"EN 39 / BS 1139 Grade 4"}];
  const sectorApplications = [{"process":"Access Platforms","details":"Load-rated structural steel platforms, anti-slip floor grating, and safety stairways for industrial maintenance access and multi-level process plant operations."},{"process":"Safety Barriers","details":"High-impact resistance barrier steel for highway crash barriers, car park barriers, machinery guards, and perimeter security fencing systems."},{"process":"Work at Height","details":"Certified scaffold tube, frame sections, and structural anchor steel for temporary and permanent work-at-height systems in construction and industrial facilities."}];
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-7xl mx-auto">
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <p className="text-base font-medium text-gray-600">Certified safety and access sector steel materials, specifications, and supply formats available in KSA.</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-8 p-6 bg-gray-100 border border-gray-200 rounded-lg text-center">
          <p className="text-base font-medium text-gray-700 mb-2"><span className="font-bold text-gray-900">IKT Safety and Access Steel Supply in KSA:</span> Full range of certified materials stocked across Saudi Arabia for immediate sector deployment and rapid project support.</p>
