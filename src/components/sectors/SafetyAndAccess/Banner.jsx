...
import banner1 from "../../../assets/images/Sectors/safty.png";

export default function Banner() {
  const slides = [
    {
      title: 'IKT Industrial Safety and Access Solutions',
      description:
      ...
      points: [
        'Total service covering advice, design, supply, and rapid delivery.',
        'Robust edge protection and flooring engineered for machinery safety.',
      ],
