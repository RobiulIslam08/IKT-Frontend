...
export default function Banner() {
  const slide = {
    title: 'IKT Steel for Safety & Access',
    description: 'IKT supplies safety-critical steel products for fall protection systems, access platforms, handrails, gratings, and safety barriers across industrial facilities, construction sites, and public infrastructure in Saudi Arabia.',
    points: [
      'Structural steel and grating for compliant access platforms, walkways, and stairways.',
      'Safety barrier and perimeter protection steel certified to industrial safety standards.',
    ],
