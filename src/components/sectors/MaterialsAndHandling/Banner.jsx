...
import banner1 from "../../../assets/images/Sectors/materials.png";

export default function Banner() {
  const slides = [
    {
      title: 'IKT Materials Handling Steel Solutions',
      description:
      ...
      points: [
        'Advanced tube laser and large-diameter plasma cutting capacity.',
        'Extensive engineering bar stocks with high-speed precision cutting.',
      ],
