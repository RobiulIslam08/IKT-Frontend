...
export default function Banner() {
  const slide = {
    title: 'IKT Steel for Materials Handling',
    description: 'IKT supplies premium structural steel, abrasion-resistant steel, and specialty alloys for conveyor systems, cranes, hoists, and bulk material handling equipment. Our materials ensure maximum durability and uptime for Saudi Arabia\'s demanding material handling operations.',
    points: [
      'High-strength and wear-resistant steel for conveyor structures, hoppers, and chutes.',
      'Certified crane steel and boom sections for heavy lifting and material handling equipment.',
    ],
