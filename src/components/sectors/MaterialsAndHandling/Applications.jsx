...
export default function Applications() {
  const applications = [
    'Automated Conveyor Systems and Sorting Frameworks',
    'Heavy-Duty Forklift Masts and Industrial Lift Components',
    'Warehouse Racking and Mezzanine Structural Support',
    'Overhead Cranes and High-Load Hoisting Equipment',
    'Bulk Material Handling Hoppers and Industrial Chutes',
    'Modular Scissor Lifts and Logistics Access Platforms',
    'Precision Rollers and High-Speed Engineering Shafts'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="mb-8">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-[#1a3a4a]">Materials Handling Applications</h2>
              </div>
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Materials Handling Equipment" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
