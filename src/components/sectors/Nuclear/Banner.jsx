...
export default function Banner() {
  const slide = {
    title: 'IKT Steel for Nuclear Applications',
    description: 'IKT supplies nuclear-grade steels and specialty alloys certified to the most rigorous international nuclear safety codes. Our materials support Saudi Arabia\'s emerging nuclear energy program with certified pressure vessel steel, stainless steel, and corrosion-resistant alloys.',
    points: [
      'ASME Section III and RCC-M certified nuclear-grade materials for reactor components.',
      'Stringent quality control and full material traceability for nuclear safety compliance.',
    ],
