...
import banner1 from "../../../assets/images/Sectors/nuclear2.png"

export default function Banner() {
  const slides = [
    {
      title: 'IKT High-Integrity Steel for Nuclear Energy',
      description:
      ...
      points: [
        'Full compliance with EN 1090 Execution Class 4 for safety-critical sites.',
        'Total traceability and accredited supply for high-integrity applications.',
      ],
