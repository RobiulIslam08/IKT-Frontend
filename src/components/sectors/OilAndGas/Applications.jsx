...
export default function Applications() {
  const applications = [
    'High-Pressure Wellhead Assemblies and Components',
    'Industrial Valve Systems and Actuators',
    'Downhole Drilling Tools and Subsurface Hardware',
    'Completion Tools for Extraction and Injection',
    'Spiral Wound Gaskets for Challenging Environments',
    'Petrochemical Heat Exchangers and Process Vessels',
    'Offshore Pipeline Infrastructure and Forged Rings'
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="mb-8">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-[#1a3a4a]">Energy Sector Applications</h2>
              </div>
          ...
          <div className="w-full h-72 md:h-[380px] lg:h-[400px] xl:h-[430px] rounded-xl overflow-hidden shadow-2xl">
            <img src={image} alt="Oil and Gas Industry Materials" className="w-full h-full object-cover object-center" />
          </div>
        </div>
      </div>
