...
export default function Banner() {
  const slide = {
    title: 'IKT Steel for Oil & Gas Industry',
    description: 'IKT is a premier supplier of API-certified pipes, pressure vessel steels, stainless steel, and specialty alloys for the oil and gas industry across Saudi Arabia. Our materials are engineered to withstand corrosive hydrocarbons, high pressures, and extreme temperatures.',
    points: [
      'API 5L, API 5CT certified linepipe and casing for oil and gas drilling operations.',
      'NACE-compliant sour service materials and H2S-resistant steels for harsh environments.',
    ],
