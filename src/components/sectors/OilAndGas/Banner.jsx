...
import banner1 from "../../../assets/images/Sectors/oilandgas.png";

export default function Banner() {
  const slides = [
    {
      title: 'IKT Specialized Oil, Gas & Petrochemical Solutions',
      description:
      ...
      points: [
        'Single-source solution for raw materials and fully finished components.',
        'Total traceability and production control for high-stakes oil field assets.',
      ],
