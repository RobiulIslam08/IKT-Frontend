...
export default function Banner() {
	...
	const slides = [
		{
			title: 'Steel Plate Drilling Services',
			description:
				'IKT introduces the Messer OmniMat® L, a high-performance profiling system engineered for unmatched precision, versatility, and industrial efficiency. This dual-capability machine combines heavy-duty gas cutting with advanced drilling technology to deliver fully processed components in a single workflow.',
			points: [
