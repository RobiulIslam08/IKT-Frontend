...
export default function Banner() {
	...
	const slides = [
		{
			title: 'Steel Plate Bending Services',
			description:
				'Core Bending Techniques.',
			points: [
				'Air Bending: The most versatile method, offering flexible angle adjustments and high efficiency.',
				'Bottoming: Delivers superior accuracy and consistency with significantly reduced spring-back.',
				'Coining: An ultra-precision technique used for extremely tight tolerances and high-load applications.',
			],
		...
		},
		{
			title: 'Plate Bending',
			description:
				'Professional plate bending services with advanced technology and expertise.',
			points: [
