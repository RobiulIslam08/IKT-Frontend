...
export default function Banner() {
	...
	const slides = [
		{
			title: 'Steel Profiling & Weld Preparation',
			description:
				'Strategic Advantage',
			points: [
				'Leading Infrastructure: Equipped with the latest in CNC, Plasma, and Waterjet technology.',
				'Continuous Investment: Ongoing capital improvements to maintain industry-leading processing speeds and accuracy.',
				'Market Position: Recognized as a premier partner for high-specification steel components in global industrial sectors.',
			],
