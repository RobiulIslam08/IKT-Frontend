...
export default function Banner() {
	...
	const slides = [
		{
			title: 'Infinity Plasma Contour Bevelling & Mechanical Bevelling',
			description:
				'Key Advantages.',
			points: [
				'Enhanced Surface Quality: Dramatically reduces angular deviations for a flatter, cleaner cut surface.',
				'1:1 Ratio Precision: Capacity to produce internal holes and slots at a 1:1 thickness-to-diameter ratio (5mm–25mm).',
				'True Hole Technology: Superior contour accuracy for both internal and external geometries.',
			],
